...
/***/ function(module, exports, __webpack_require__) {
	...
	var Organization = function (_BaseComponent) {
	    _inherits(Organization, _BaseComponent);
	    ...
	    function Organization() {
	        ...
	        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_Object$getPrototypeO = Object.getPrototypeOf(Organization)).call.apply(_Object$getPrototypeO, [this].concat(args))), _this), _this.state = {
	            showModal: false,
	            organizations: [],
	            gData: [],
	            ...
	            _this.setState({
	                gData: convertToTree(_this.state.organizations)
	            });
	        }, _this.handleSubmit = function (e) {
	            e.preventDefault();
	            _this.props.form.validateFields(['key', 'text', 'description', 'remark'], function (errors, values) {
	                if (!!errors) {
	                    return;
	                }
	                var data = [].concat(_toConsumableArray(_this.state.gData));
	            ...
	            _this.request().post('/organization/organizations').params({ organizations: painData }).success(function () /* data, res */{
	        ...
	        }, _this.handleAddTopOrg = function () {
	            var setFieldsValue = _this.props.form.setFieldsValue;
	            ...
	            _this.props.form.validateFields(['key', 'text'], function (errors) {
	                if (!!errors) {
	                    _antd.message.info('请先选择一个组织');
	                    return;
	                }
	                var setFieldsValue = _this.props.form.setFieldsValue;
	            ...
	            _this.props.form.validateFields(['newText', 'newDescription', 'newRemark'], function (errors, values) {
	                if (!!errors) {
	                    return;
	                }
	                var data = [].concat(_toConsumableArray(_this.state.gData));
	    ...
	    _createClass(Organization, [{
	        ...
	        value: function render() {
	                        ...
	                        return _react2.default.createElement(
	                            TreeNode,
	                            {
	                                ...
	                                title: _react2.default.createElement(
	                                    'span',
	                                    null,
	                                    _react2.default.createElement(_component.FAIcon, { type: item.description }),
	                                    ' ',
	                                    item.text
	                                )
	                            },
	            ...
	            var descriptionProps = getFieldProps('description', descriptionFieldProps);
	            var newDescriptionProps = getFieldProps('newDescription', descriptionFieldProps);

	            var remarkProps = getFieldProps('remark', remarkFieldProps);
	            var newRemarkProps = getFieldProps('newRemark', remarkFieldProps);
	            ...
	            return _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        ...
	                        _react2.default.createElement(
	                            ...
	                            _react2.default.createElement(
	                                ...
	                                _react2.default.createElement(
	                                    _antd.Button,
	                                    { type: 'primary', size: 'large', onClick: this.handleAddTopOrg },
	                                    '添加顶级组织'
	                                ),
	                                '   ',
	                                _react2.default.createElement(
	                        ...
	                        _react2.default.createElement(
	                            ...
	                            _react2.default.createElement(
	                                ...
	                                _extends({}, formItemLayout, {
	                                    label: '描述：',
	                                    hasFeedback: true }),
	                                _react2.default.createElement(_antd.Input, _extends({}, descriptionProps, {
	                                    onChange: function onChange(e) {
	                            ...
	                            _react2.default.createElement(
	                                ...
	                                _extends({}, formItemLayout, {
	                                    label: '备注：',
	                                    hasFeedback: true }),
	                                _react2.default.createElement(_antd.Input, _extends({}, remarkProps, {
	                                    onChange: function onChange(e) {
	                ...
	                _react2.default.createElement(
	                    _antd.Modal,
	                    { title: '添加子组织', visible: this.state.showModal, onOk: this.handleModalOk, onCancel: this.hideModal },
	                    _react2.default.createElement(
	                        _antd.Form,
	                        { horizontal: true, form: this.props.form },
	                        _react2.default.createElement(
	                        ...
	                        _react2.default.createElement(
	                            ...
	                            _extends({}, formItemLayout, {
	                                label: '描述：',
	                                hasFeedback: true }),
	                            _react2.default.createElement(_antd.Input, _extends({}, newDescriptionProps, {
	                                placeholder: '请输入组织描述'
	                            }))
	                        ),
	                        _react2.default.createElement(
	                            ...
	                            _extends({}, formItemLayout, {
	                                label: '备注：',
	                                hasFeedback: true }),
	                            _react2.default.createElement(_antd.Input, _extends({}, newRemarkProps, {
	                                placeholder: '请输入备注'
	                            }))
	                        )
	                    )
	...
	exports.default = createForm()(Organization);
	module.exports = exports['default'];
