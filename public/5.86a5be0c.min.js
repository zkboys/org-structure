...
/***/ function(module, exports, __webpack_require__) {
	...
	var _rcQueueAnim = __webpack_require__(114);

	var _rcQueueAnim2 = _interopRequireDefault(_rcQueueAnim);

	var _reactRouter = __webpack_require__(122);

	var _SidebarMenuUtil = __webpack_require__(137);

	var _Settings = __webpack_require__(125);

	var _Settings2 = _interopRequireDefault(_Settings);

	var _pubsubmsg = __webpack_require__(119);
	...
	var Page = function (_React$Component) {
	    ...
	    function Page() {
	        ...
	        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_Object$getPrototypeO = Object.getPrototypeOf(Page)).call.apply(_Object$getPrototypeO, [this].concat(args))), _this), _this.state = {
	            pageHeader: '',
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.DateTimeAreaItem = exports.ComboboxItem = exports.SelectItem = exports.CheckBoxItem = exports.RadioItem = undefined;

	var _RadioItem = __webpack_require__(131);

	var _RadioItem2 = _interopRequireDefault(_RadioItem);

	var _CheckBoxItem = __webpack_require__(128);

	var _CheckBoxItem2 = _interopRequireDefault(_CheckBoxItem);

	var _SelectItem = __webpack_require__(132);

	var _SelectItem2 = _interopRequireDefault(_SelectItem);

	var _ComboboxItem = __webpack_require__(129);

	var _ComboboxItem2 = _interopRequireDefault(_ComboboxItem);

	var _DateTimeAreaItem = __webpack_require__(130);

	var _DateTimeAreaItem2 = _interopRequireDefault(_DateTimeAreaItem);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	exports.RadioItem = _RadioItem2.default;
	exports.CheckBoxItem = _CheckBoxItem2.default;
	exports.SelectItem = _SelectItem2.default;
	exports.ComboboxItem = _ComboboxItem2.default;
	exports.DateTimeAreaItem = _DateTimeAreaItem2.default;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _animTypes = __webpack_require__(113);
	...
	if (typeof document !== 'undefined' && typeof window !== 'undefined') {
	  ...
	  velocity = __webpack_require__(116);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _QueueAnim = __webpack_require__(112);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _request = __webpack_require__(117);

	var _request2 = _interopRequireDefault(_request);

	var _tipMessage = __webpack_require__(143);
	...
	var BaseComponent = function (_React$Component) {
	    ...
	    function BaseComponent() {
	        ...
	        _this.request = function () {
	            ...
	            return {
	                ...
	                timeout: function timeout(_timeout) {
	                    this.outTime = _timeout;
	                },
	                noLoading: function noLoading() {
	                    this.withNoLoading = true;
	                    return this;
	                },
	                setErrorMsg: function setErrorMsg(errorMsg) {
	                    this.errorMsg = _tipMessage2.default[errorMsg];
	                    return this;
	                },
	                ...
	                success: function success(cb) {
	                    ...
	                    // ajax结束回调函数
	                    var endCb = function endCb(err, res) {
	                        _this2.isEnd = true;
	                        if (!_this2.withNoLoading) {
	                            self.endLoading();
	                        }
	                        if (err || !res.ok) {
	                            if (_this2.errorCb) {
	                                _this2.errorCb(err, res);
	                            } else {
	                                // FIXME 这个判断不靠谱，但是暂时可用
	                                if (String(err).indexOf('the network is offline') > -1) {
	                                    _antd.message.error('网络异常，请检查您得网络！', 1);
	                                } else {
	                                    _antd.message.error(_this2.errorMsg || res && res.body && res.body.message || '未知系统错误', 1);
	                                }
	                            }
	                        } else {
	                            if (res.type === 'text/html') {
	                                ...
	                                if (_this2.successCb) {
	                                    _this2.successCb(res.body || res, res);
	                                }
	                            }
	                        }
	                        // 所有处理完成之后的操作
	                    ...
	                    var st = setTimeout(function () {
	                        if (!_this2.isEnd && request) {
	                            var errorMassage = '请求超时，请检查您的网络';
	                    ...
	                    if (this.type === 'get') {
	                        request = _request2.default.get(this.url).query(this.paramsData).end(endCb);
	                    } else if (this.type === 'put') {
	                        request = _request2.default.put(this.url).send(this.paramsData).end(endCb);
	                    } else if (this.type === 'delete') {
	                        request = _request2.default.del(this.url).send(this.paramsData).end(endCb);
	                    } else {
	                        request = _request2.default.post(this.url).send(this.paramsData).end(endCb);
	                    }
	        ...
	        _this.currentUser = _common.Storage.session.get('currentLoginUser');
	        _this.currentUser.hasPermission = function (permission) {
	            var currentUserPermissions = _this.currentUser.permissions;
	    ...
	    _createClass(BaseComponent, [{
	        ...
	        value: function componentWillUnmount() {
	            ...
	            this.requestTimeouts.forEach(function (t) {
	                if (t) {
	                    clearTimeout(t);
	                }
	            });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var PaginationComponent = function (_React$Component) {
	    ...
	    function PaginationComponent() {
	        ...
	        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_Object$getPrototypeO = Object.getPrototypeOf(PaginationComponent)).call.apply(_Object$getPrototypeO, [this].concat(args))), _this), _this.state = {
	            pageSize: _this.props.options.pageSize
	        }, _this.handleChange = function (currentPage, pageSize) {
	            if (pageSize) {
	                _this.setState({
	                    pageSize: pageSize
	                });
	            ...
	            if (_this.props.options.onChange) {
	                _this.props.options.onChange(currentPage, pageSize);
	            }
	        }, _temp), _possibleConstructorReturn(_this, _ret);
	    }
	    ...
	    _createClass(PaginationComponent, [{
	        ...
	        value: function render() {
	            ...
	            var showSizeChanger = options.showSizeChanger;
	            ...
	            if (totalPage <= 1) {
	                style = (0, _objectAssign2.default)({}, { display: 'none' }, style);
	            }
	            return _react2.default.createElement(
	                'div',
	                { className: 'pagination-component', style: style },
	                _react2.default.createElement(
	                    'div',
	                    { className: 'pagination-wrap' },
	                    _react2.default.createElement(_antd.Pagination, _extends({}, props, {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var QueryTerms = function (_React$Component) {
	    _inherits(QueryTerms, _React$Component);
	    ...
	    function QueryTerms() {
	        ...
	        _classCallCheck(this, QueryTerms);

	        for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
	            args[_key] = arguments[_key];
	        }

	        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_Object$getPrototypeO = Object.getPrototypeOf(QueryTerms)).call.apply(_Object$getPrototypeO, [this].concat(args))), _this), _this.setDefaultValue = function (itemOptions) {
	            var _this$props$form$setF;

	            var type = itemOptions.type;
	            var defaultValue = itemOptions.defaultValue;
	            var name = itemOptions.name;
	            var startName = itemOptions.startName;
	            var endName = itemOptions.endName;
	            var startDefaultValue = itemOptions.startDefaultValue;
	            var endDefaultValue = itemOptions.endDefaultValue;
	            ...
	            if (['date', 'time', 'dateTime', 'month'].includes(type)) {
	                if (typeof defaultValue === 'string') {
	                    defaultValue = _this.stringToDate(defaultValue, format[type]);
	                }
	                if (typeof startDefaultValue === 'string') {
	                    startDefaultValue = _this.stringToDate(startDefaultValue, format[type]);
	                }
	                if (typeof endDefaultValue === 'string') {
	                    endDefaultValue = _this.stringToDate(endDefaultValue, format[type]);
	                }
	            }
	            // tabs相关默认值
	            ...
	            _this.props.form.setFieldsValue((_this$props$form$setF = {}, _defineProperty(_this$props$form$setF, name, defaultValue), _defineProperty(_this$props$form$setF, startName, startDefaultValue), _defineProperty(_this$props$form$setF, endName, endDefaultValue), _this$props$form$setF));
	        }, _this.state = {}, _this.getFormData = function () {
	            var formData = null;
	            _this.props.form.validateFieldsAndScroll(function (errors, values) {
	                ...
	                var dateToString = options.resultDateToString === undefined ? true : options.resultDateToString;
	                    ...
	                    options.items.forEach(function (value) {
	                        if (value instanceof Array) {
	                            value.forEach(function (v) {
	                                var format = v.format;
	                                var name = v.name;
	                                var startName = v.startName;
	                                var endName = v.endName;

	                                if (values[name] instanceof Date) {
	                                    values[name] = _this.dateToString(values[name], format);
	                                }
	                                if (values[startName] instanceof Date) {
	                                    values[startName] = _this.dateToString(values[startName], format);
	                                }
	                                if (values[endName] instanceof Date) {
	                                    values[endName] = _this.dateToString(values[endName], format);
	                                }
	                            });
	                        } else {
	                            var format = value.format;
	                            var name = value.name;
	                            var startName = value.startName;
	                            var endName = value.endName;
	            ...
	            if (formData) {
	                _this.props.options.onSubmit(formData);
	            }
	        }, _this.dateToString = function (date, format) {
	            format = format.replace('yyyy', 'YYYY');
	            format = format.replace('dd', 'DD');
	            return (0, _moment2.default)(date).format(format);
	        }, _this.stringToDate = function (str, format) {
	            format = format.replace('yyyy', 'YYYY');
	            format = format.replace('dd', 'DD');
	            return (0, _moment2.default)(str, format).toDate();
	        }, _this.getItem = function (options, itemOptions) {
	            itemOptions = (0, _objectAssign2.default)({}, {
	                fieldWidth: '150px',
	                labelWidth: options.labelWidth || 'auto'
	            }, itemOptions);
	            var searchOnChange = itemOptions.searchOnChange;
	            var itemType = itemOptions.type;
	            var label = itemOptions.label;
	            var name = itemOptions.name;
	            var startName = itemOptions.startName;
	            var endName = itemOptions.endName;
	            var props = itemOptions.props;
	            var fieldWidth = itemOptions.fieldWidth;
	            var labelWidth = itemOptions.labelWidth;
	            var labelUnifiedFontCount = itemOptions.labelUnifiedFontCount;
	            ...
	            var placeholder = itemOptions.placeholder;
	            ...
	            var eleProps = (0, _objectAssign2.default)({}, {
	            ...
	            var fieldPropsOptions = void 0;
	            var startFieldPropsOptions = void 0;
	            var endFieldPropsOptions = void 0;
	            if (name) {
	            ...
	            var labelJsx = label ? _react2.default.createElement(
	                'div',
	                labelProps,
	                label,
	                '：'
	            ...
	            var searchDelay = 300;
	            eleProps.onChange = function (e) {
	                var value = e && e.target ? e.target.value : e;
	                setFieldsValue(_defineProperty({}, name, value));
	                if (['input', 'inputNumber', 'combobox'].includes(itemType)) {
	                ...
	                if (options.onChange) {
	                    options.onChange(_this.getFormData());
	                }
	            };
	            eleProps.onKeyDown = function (e) {
	                if (e.key === 'Enter') {
	                    _this.handleSubmit();
	                }
	            };
	            switch (itemType) {
	                case 'input':
	                    {
	                        return _react2.default.createElement(
	                            ...
	                            _react2.default.createElement(
	                                FormItem,
	                                itemProps,
	                                _react2.default.createElement(_antd.Input, _extends({}, fieldPropsOptions, eleProps))
	                            )
	                        );
	                    }
	                case 'inputNumber':
	                    {
	                        var min = itemOptions.min;
	                        var max = itemOptions.max;
	                        var inputProps = {};
	                        if (min !== undefined) {
	                            inputProps.min = min;
	                        }
	                        ...
	                        return _react2.default.createElement(
	                            ...
	                            _react2.default.createElement(
	                                FormItem,
	                                itemProps,
	                                _react2.default.createElement(_antd.InputNumber, _extends({}, fieldPropsOptions, inputProps, eleProps))
	                            )
	                        );
	                    }
	                case 'combobox':
	                    {
	                        var separator = itemOptions.separator;
	                        var size = itemOptions.size;
	                        var opts = itemOptions.options;
	                        var optionsFilter = itemOptions.optionsFilter;
	                        var url = itemOptions.url;
	                        var defaultValue = itemOptions.defaultValue;
	                        return _react2.default.createElement(
	                            _antd.Col,
	                            null,
	                            ...
	                            _react2.default.createElement(
	                                FormItem,
	                                itemProps,
	                                _react2.default.createElement(_index.ComboboxItem, _extends({
	                                    separator: separator,
	                                    size: size,
	                                    url: url,
	                ...
	                case 'selectMultiple':
	                    {
	                        var _size = itemOptions.size;
	                        var _opts = itemOptions.options;
	                        var _optionsFilter = itemOptions.optionsFilter;
	                        var _url = itemOptions.url;
	                        var _defaultValue = itemOptions.defaultValue;
	                        if (itemType === 'selectSearch') {
	                            eleProps = (0, _objectAssign2.default)({}, { showSearch: true }, eleProps);
	                        }
	                        if (itemType === 'selectMultiple') {
	                            eleProps = (0, _objectAssign2.default)({}, { multiple: true }, eleProps);
	                        }
	                        return _react2.default.createElement(
	                            _antd.Col,
	                            null,
	                            ...
	                            _react2.default.createElement(
	                                ...
	                                _react2.default.createElement(
	                                    ...
	                                    _extends({
	                                        ...
	                                        options: _opts,
	                                        optionsFilter: _optionsFilter
	                                    }, fieldPropsOptions, eleProps),
	                                    _opts.map(function (v, i) {
	                                        return _react2.default.createElement(
	                                            Option,
	                                            { key: i, value: v.value },
	                                            v.label
	                ...
	                case 'cascader':
	                    {
	                        return _react2.default.createElement(
	                            ...
	                            _react2.default.createElement(
	                                FormItem,
	                                itemProps,
	                                _react2.default.createElement(_antd.Cascader, _extends({}, fieldPropsOptions, {
	                ...
	                case 'checkbox':
	                    {
	                        ...
	                        var type = ['radioButton', 'checkboxButton'].includes(itemType) ? 'button' : 'radio';
	                        var _size2 = itemOptions.size;
	                        var _opts2 = itemOptions.options;
	                        var _optionsFilter2 = itemOptions.optionsFilter;
	                        var minCount = itemOptions.minCount;
	                        var _url2 = itemOptions.url;
	                        var expandable = itemOptions.expandable;
	                        var _defaultValue2 = itemOptions.defaultValue;
	                        var Element = ['checkbox', 'checkboxButton'].includes(itemType) ? _index.CheckBoxItem : _index.RadioItem;
	                        if (type === 'button') {
	                        ...
	                        return _react2.default.createElement(
	                            ...
	                            _react2.default.createElement(
	                                ...
	                                _react2.default.createElement(
	                                    'div',
	                                    { className: 'text-label', ref: 'label' },
	                                    labelJsx
	                                ),
	                                _react2.default.createElement(
	                                    'div',
	                                    { style: { marginLeft: marginLeft } },
	                                    _react2.default.createElement(Element, _extends({
	                                        type: type,
	                                        size: _size2,
	                                        url: _url2,
	                                        minCount: minCount,
	                ...
	                case 'month':
	                    {
	                        var format = itemOptions.format;
	                        var _Element = _antd.DatePicker;
	                        if (itemType === 'month') {
	                            _Element = _antd.DatePicker.MonthPicker;
	                        }
	                        if (itemType === 'time') {
	                            _Element = _antd.TimePicker;
	                        }
	                        ...
	                        return _react2.default.createElement(
	                            ...
	                            _react2.default.createElement(
	                                FormItem,
	                                itemProps,
	                                _react2.default.createElement(_Element, _extends({}, fieldPropsOptions, {
	                                    format: format
	                                }, eleProps))
	                            )
	                        );
	                ...
	                case 'dateTimeArea':
	                    {
	                        var typeProps = _defineProperty({}, itemType, true);
	                        ...
	                        return _react2.default.createElement(
	                            ...
	                            _react2.default.createElement(
	                                FormItem,
	                                itemProps,
	                                _react2.default.createElement(_index.DateTimeAreaItem, _extends({}, typeProps, {
	                                    width: fieldWidth,
	                ...
	                case 'tabs':
	                    {
	                        ...
	                        return _react2.default.createElement(
	                            ...
	                            itemOptions.options.map(function (v) {
	                                return _react2.default.createElement(TabPane, { tab: v.label, key: v.value });
	                            })
	                        );
	                    }
	                case 'customer':
	                    {
	                        var Component = itemOptions.component;
	                        return _react2.default.createElement(
	                            _antd.Col,
	                            null,
	                            labelJsx,
	                            _react2.default.createElement(
	                                FormItem,
	                                itemProps,
	                                _react2.default.createElement(Component, _extends({}, fieldPropsOptions, eleProps))
	                            )
	                        );
	                    }
	                default:
	    ...
	    _createClass(QueryTerms, [{
	        key: 'componentWillMount',
	        value: function componentWillMount() {
	            var _this2 = this;

	            // 默认值要写在这里
	            this.props.options.items.forEach(function (v) {
	                if (v instanceof Array) {
	                    v.forEach(function (value) {
	                        _this2.setDefaultValue(value);
	                    });
	                } else {
	                    _this2.setDefaultValue(v);
	                }
	            });
	        }
	    }, {
	        key: 'componentDidMount',
	        value: function componentDidMount() {
	            var onDidMount = this.props.options.onDidMount;
	            var onChange = this.props.options.onChange;
	        ...
	        value: function render() {
	            ...
	            var options = this.props.options;
	            var searchBtnText = options.searchBtnText || '查询';
	            var extraAfterSearchButton = options.extraAfterSearchButton;
	            var items = options.items.map(function (value, index, array) {
	                ...
	                if (index === array.length - 1) {
	                    if (options.showSearchBtn) {
	                        buttons.push(_react2.default.createElement(
	                            ...
	                            _react2.default.createElement(
	                                FormItem,
	                                { className: 'query-terms-item', style: { marginTop: '-1px' } },
	                                _react2.default.createElement(
	                                    _antd.Button,
	                                    { type: 'primary', onClick: _this3.handleSubmit },
	                                    searchBtnText
	                                )
	                            )
	                        ));
	                ...
	                if (value instanceof Array) {
	                    ...
	                    return _react2.default.createElement(
	                        _antd.Row,
	                        _extends({ key: index }, rowProps),
	                        value.map(function (v, i, a) {
	                            return [_this3.getItem(options, v), i === a.length - 1 ? buttons : undefined];
	                        })
	                    );
	                }
	                // 一行一个查询条件
	                return _react2.default.createElement(
	                    _antd.Row,
	                    _extends({ key: index }, rowProps),
	                    _this3.getItem(options, value),
	                    buttons
	                );
	            });
	            return _react2.default.createElement(
	                'div',
	                { className: 'query-terms' },
	                _react2.default.createElement(
	                    _antd.Form,
	...
	exports.default = createForm()(QueryTerms);
	module.exports = exports['default'];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _FAIcon = __webpack_require__(9);
	...
	var RadioItem = function (_React$Component) {
	    ...
	    function RadioItem() {
	        ...
	        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_Object$getPrototypeO = Object.getPrototypeOf(RadioItem)).call.apply(_Object$getPrototypeO, [this].concat(args))), _this), _this.state = {
	            options: _this.props.options
	        }, _this.loadingValue = Symbol(), _this.handleExpandBtnClick = function (e) {
	            var button = e.currentTarget;
	            var btnClassNames = button.className.split(' ');
	    ...
	    _createClass(RadioItem, [{
	        ...
	        value: function componentDidMount() {
	            ...
	            if (url) {
	                (function () {
	                    ...
	                    var optionsFilter = _this2.props.optionsFilter;
	                    _superagent2.default.get(url).end(function (err, res) {
	                        options = options.filter(function (v) {
	                            return v.value !== _this2.loadingValue;
	                        });
	                        if (err) {
	                            options.push({
	                                value: _this2.loadingValue,
	                                label: _react2.default.createElement(
	                                    "div",
	                                    { className: "spin-wrap error" },
	                                    "获取数据失败"
	                                )
	                            });
	                        } else {
	                            var newOptions = optionsFilter(res);
	        ...
	        value: function render() {
	            ...
	            var showCount = this.props.minCount;
	            var expandable = this.props.expandable;
	            var showExpandedBtn = expandable && options.length > showCount;
	            options = expandable ? options.filter(function (v, i, a) {
	                if (_this3.state.expanded) {
	                    return true;
	                }
	                return i < showCount;
	            }) : options;
	            ...
	            return _react2.default.createElement(
	                ...
	                options.map(function (v, i) {
	                    var key = i;
	                    if (v.value === _this3.loadingValue) {
	                        return _react2.default.createElement(
	                            "span",
	                            { key: key },
	                            v.label
	                    ...
	                    return _react2.default.createElement(
	                        "label",
	                        { key: key, className: "check-box-group" },
	                        _react2.default.createElement(_antd.Checkbox, { checked: value.includes(v.value),
	                            onClick: function onClick() {
	                                _this3.handleChange(v.value);
	                            } }),
	                        v.label
	                ...
	                showExpandedBtn ? _react2.default.createElement(
	                    _antd.Button,
	                    {
	                        type: "ghost",
	                        title: "显示更多",
	                    ...
	                    _react2.default.createElement(_FAIcon2.default, { type: "fa-angle-double-down" })
	                ) : ''
	            );
	        }
	    }]);
	...
	RadioItem.defaultProps = {
	    ...
	    expandable: false,
	    options: [],
	    optionsFilter: function optionsFilter(res) {
	        return res.body.results;
	    }
	};
	RadioItem.propTypes = {
	    options: _react2.default.PropTypes.arrayOf(_react2.default.PropTypes.object).isRequired,
	    minCount: _react2.default.PropTypes.number,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ComboboxItem = function (_React$Component) {
	    _inherits(ComboboxItem, _React$Component);
	    ...
	    function ComboboxItem() {
	        ...
	        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_Object$getPrototypeO = Object.getPrototypeOf(ComboboxItem)).call.apply(_Object$getPrototypeO, [this].concat(args))), _this), _this.state = {
	            options: _this.props.options
	        }, _this.handleChange = function (value) {
	            var comboboxOptions = void 0;
	            var separator = _this.props.separator;
	            if (!value || value.indexOf(separator) >= 0) {
	                comboboxOptions = [];
	            } else {
	                comboboxOptions = _this.state.options.map(function (opt) {
	                    var label = "" + value + separator + opt;
	                    return _react2.default.createElement(
	                        Option,
	                        { key: label },
	                        label
	...
	var RadioItem = function (_React$Component) {
	    ...
	    function RadioItem() {
	        ...
	        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_Object$getPrototypeO = Object.getPrototypeOf(RadioItem)).call.apply(_Object$getPrototypeO, [this].concat(args))), _this), _this.state = {
	            ...
	            disableBefore: null,
	            disableAfter: null,
	            startValue: _this.props.startFieldProps.value || _this.props.startDefaultValue,
	            endValue: _this.props.endFieldProps.value || _this.props.endDefaultValue
	        }, _this.dateToString = function (date) {
	            return (0, _moment2.default)(date).format(_this.state.momentFormat);
	        }, _this.stringToDate = function (str) {
	            return (0, _moment2.default)(str, _this.state.momentFormat).toDate();
	        }, _this.timeStampToString = function (timeStamp) {
	            return (0, _moment2.default)(timeStamp).format(_this.state.momentFormat);
	            ...
	            if (typeof endValue === 'string') {
	                endValue = _this.stringToDate(endValue);
	            }

	            startValue = _this.timeStampToString(startValue.getTime());
	            endValue = _this.timeStampToString(endValue.getTime());
	            var disEnd = startValue > endValue;
	            var disBefore = false;
	            var disableBefore = _this.state.disableBefore;
	            if (disableBefore) {
	                disableBefore = _this.timeStampToString(disableBefore.getTime());
	                disBefore = startValue < disableBefore;
	            }
	            var disAfter = false;
	            var disableAfter = _this.state.disableAfter;
	            if (disableAfter) {
	                disableAfter = _this.timeStampToString(disableAfter.getTime());
	            ...
	            if (typeof startValue === 'string') {
	                startValue = _this.stringToDate(startValue);
	            }

	            startValue = _this.timeStampToString(startValue.getTime());
	            endValue = _this.timeStampToString(endValue.getTime());

	            var disStart = endValue < startValue;
	            var disBefore = false;
	            var disableBefore = _this.state.disableBefore;
	            if (disableBefore) {
	                disableBefore = _this.timeStampToString(disableBefore.getTime());
	    ...
	    _createClass(RadioItem, [{
	        ...
	        value: function componentWillMount() {
	            ...
	            var isDate = this.props.date;
	            var isDateArea = this.props.dateArea;
	            var isTime = this.props.time;
	            var isTimeArea = this.props.timeArea;
	            var isDateTime = this.props.dateTime;
	            var isDateTimeArea = this.props.dateTimeArea;
	            var itemType = isDate && 'date' || isDateArea && 'dateArea' || isTime && 'time' || isTimeArea && 'timeArea' || isDateTime && 'dateTime' || isDateTimeArea && 'dateTimeArea';
	            var format = this.props.format || defaultFormat[itemType];
	            var momentFormat = format.replace('yyyy', 'YYYY').replace('dd', 'DD');
	            this.setState({
	                format: format,
	                momentFormat: momentFormat
	            });

	            var disableBefore = this.props.disableBefore;
	            var disableAfter = this.props.disableAfter;
	        ...
	        value: function render() {
	            ...
	            var resultDateToString = this.props.resultDateToString;
	            var isDateArea = this.props.dateArea;
	            var isTimeArea = this.props.timeArea;
	            var isDateTimeArea = this.props.dateTimeArea;
	            var width = this.props.width;
	            var splitWidth = 10;
	            var itemWidth = (window.parseInt(width) - splitWidth) / 2 + 'px';
	            ...
	            var startFieldPropsOptions = this.props.startFieldProps;
	            var endFieldPropsOptions = this.props.endFieldProps;
	            var handleChange = function handleChange(name) {
	                //  柯里化
	                return function (value) {
	                    _this2.setState(_defineProperty({}, name, value));
	                    if (resultDateToString && value) {
	                        value = _this2.dateToString(value);
	                    }
	                    ...
	                    if (_this2.props.onChange) {
	                        _this2.props.onChange(value, name);
	                    }
	                };
	            };
	            var startEleProps = (0, _objectAssign2.default)({}, eleProps, { onChange: handleChange('startValue') });
	            var endEleProps = (0, _objectAssign2.default)({}, eleProps, { onChange: handleChange('endValue') });

	            var startDefaultValue = startFieldPropsOptions.value || this.props.startDefaultValue;
	            var endDefaultValue = endFieldPropsOptions.value || this.props.endDefaultValue;
	            ...
	            var endPicker = void 0;
	            if (isDateArea || isDateTimeArea) {
	                startPicker = _react2.default.createElement(_antd.DatePicker, _extends({
	                    disabledDate: this.disabledStartDate
	                }, startFieldPropsOptions, {
	                    defaultValue: startDefaultValue,
	                    format: this.state.format
	                }, startEleProps));
	                endPicker = _react2.default.createElement(_antd.DatePicker, _extends({
	            ...
	            if (isTimeArea) {
	                startPicker = _react2.default.createElement(_antd.TimePicker, _extends({}, startFieldPropsOptions, {
	                    defaultValue: startDefaultValue,
	                    format: this.state.format
	                }, startEleProps));
	                endPicker = _react2.default.createElement(_antd.TimePicker, _extends({}, endFieldPropsOptions, {
	                    defaultValue: endDefaultValue,
	                    format: this.state.format
	                }, endEleProps));
	            }
	            ...
	            return _react2.default.createElement(
	                'div',
	                { className: 'form-item form-item-datetime-area' },
	                _react2.default.createElement(
	                    'div',
	                    { className: 'area-item', style: { width: itemWidth } },
	                    startPicker
	                ),
	                _react2.default.createElement(
	                    'div',
	                    { className: 'area-split', style: { width: splitWidth } },
	                    _react2.default.createElement(
	                        'p',
	                ...
	                _react2.default.createElement(
	                    ...
	                    options.map(function (v, i) {
	                        ...
	                        if (button) {
	                            return _react2.default.createElement(
	                                RadioButton,
	                                _extends({ key: key, value: v.value }, radioProps),
	                                v.label
	                            );
	                        } else {
	                            return _react2.default.createElement(
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SelectItem = function (_React$Component) {
	    ...
	    function SelectItem() {
	        ...
	        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_Object$getPrototypeO = Object.getPrototypeOf(SelectItem)).call.apply(_Object$getPrototypeO, [this].concat(args))), _this), _this.state = {
	            options: _this.props.options
	        }, _this.loadingValue = Symbol(), _temp), _possibleConstructorReturn(_this, _ret);
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.PreviewImage = exports.Panel = exports.OrderTable = exports.FormItem = exports.FAIcon = exports.SwitchRemote = exports.BaseComponent = exports.PaginationComponent = exports.QueryTerms = exports.ToolBar = exports.UserAvatar = undefined;

	var _QueryTerms = __webpack_require__(124);

	var _QueryTerms2 = _interopRequireDefault(_QueryTerms);

	var _PaginationComponent = __webpack_require__(123);

	var _PaginationComponent2 = _interopRequireDefault(_PaginationComponent);

	var _BaseComponent = __webpack_require__(120);

	var _BaseComponent2 = _interopRequireDefault(_BaseComponent);

	var _SwitchRemote = __webpack_require__(135);

	var _SwitchRemote2 = _interopRequireDefault(_SwitchRemote);

	var _FAIcon = __webpack_require__(9);

	var _FAIcon2 = _interopRequireDefault(_FAIcon);

	var _formItem = __webpack_require__(11);

	var FormItem = _interopRequireWildcard(_formItem);

	var _OrderTable = __webpack_require__(144);
	...
	var _PreviewImage = __webpack_require__(145);

	var _PreviewImage2 = _interopRequireDefault(_PreviewImage);

	var _ToolBar = __webpack_require__(146);

	var _ToolBar2 = _interopRequireDefault(_ToolBar);

	var _UserAvatar = __webpack_require__(153);
	...
	exports.UserAvatar = _UserAvatar2.default;
	exports.ToolBar = _ToolBar2.default;
	exports.QueryTerms = _QueryTerms2.default;
	exports.PaginationComponent = _PaginationComponent2.default;
	exports.BaseComponent = _BaseComponent2.default;
	exports.SwitchRemote = _SwitchRemote2.default;
	exports.FAIcon = _FAIcon2.default;
	exports.FormItem = FormItem;
	exports.OrderTable = _OrderTable2.default;
	...
	var Panel = function (_React$Component) {
	    ...
	    _createClass(Panel, [{
	        ...
	        value: function render() {
	            ...
	            var span = Math.floor(12 / headerLength);
	            for (var i = 0; i < headerLength; i++) {
	                var h = headers[i];
	                headerJsx.push(_react2.default.createElement(
	                    _antd.Col,
	                    { key: i + '-title', span: String(span), className: 'title' },
	                    h.title
	                ));
	                headerJsx.push(_react2.default.createElement(
	                    _antd.Col,
	                    { key: i + '-sub-title', span: String(span), className: 'sub-title' },
	                    h.subTitle || ' '
	                ));
	            }
	            var style = (0, _objectAssign2.default)({}, { width: this.props.width }, this.props.style);
	            return _react2.default.createElement(
	                'div',
	                { className: "panel-wrap " + (this.props.className || ''), style: style },
	                _react2.default.createElement(
	                    'div',
	                    { className: 'header' },
	                    _react2.default.createElement(
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SwitchRemote = function (_React$Component) {
	    _inherits(SwitchRemote, _React$Component);
	    ...
	    function SwitchRemote() {
	        ...
	        _classCallCheck(this, SwitchRemote);

	        for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
	            args[_key] = arguments[_key];
	        }

	        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_Object$getPrototypeO = Object.getPrototypeOf(SwitchRemote)).call.apply(_Object$getPrototypeO, [this].concat(args))), _this), _this.state = {
	            isLoading: false,
	            ...
	            var loading = _react2.default.createElement(_antd.Icon, { type: 'loading' });
	            _this.setState({
	                isLoading: true,
	                checkedChildren: loading,
	                unCheckedChildren: loading
	            });
	            params[_this.props.checkedKey] = _this.state.checked;
	            _request2.default.put(url).send(params).end(function (err, res) {
	                if (err || !res.ok) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var OrderTable = function (_React$Component) {
	    ...
	    function OrderTable() {
	        ...
	        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_Object$getPrototypeO = Object.getPrototypeOf(OrderTable)).call.apply(_Object$getPrototypeO, [this].concat(args))), _this), _this.state = {}, _this.getValue = function (record, index, col) {
	            var text = void 0;
	            if (col.dataIndex) {
	    ...
	    _createClass(OrderTable, [{
	        ...
	        value: function render() {
	            ...
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    "div",
	                    { className: "ant-table order-table" },
	                    _react2.default.createElement(
	                        "table",
	                        null,
	                        _react2.default.createElement(
	                            ...
	                            data.map(function (v, i, a) {
	                                return [_react2.default.createElement(
	                                    ...
	                                    _react2.default.createElement(
	                                        "td",
	                                        { colSpan: subHeadColSpan },
	                                        subHead.map(function (vv, ii, aa) {
	                                            return _react2.default.createElement(
	                                                "div",
	                                                { key: i + '-' + ii, style: { width: 100 / aa.length + '%' } },
	                                                vv.title,
	                                                "：",
	                                                _this2.getValue(v, i, vv)
	                                            );
	                                        })
	                                    )
	                                ), _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    "div",
	                    { className: "ant-table-placeholder", style: { position: 'static', display: data && data.length ? 'none' : 'block' } },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ToolBar = function (_React$Component) {
	    ...
	    function ToolBar() {
	        ...
	        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_Object$getPrototypeO = Object.getPrototypeOf(ToolBar)).call.apply(_Object$getPrototypeO, [this].concat(args))), _this), _this.state = {}, _temp), _possibleConstructorReturn(_this, _ret);
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _framework = __webpack_require__(136);
	...
	var convertToTree = _common.Common.convertToTree;
	var TreeNode = _antd.Tree.TreeNode;
	var createForm = _antd.Form.create;
	var FormItem = _antd.Form.Item;

	var SystemMenu = function (_BaseComponent) {
	    _inherits(SystemMenu, _BaseComponent);
	    ...
	    function SystemMenu() {
	        ...
	        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_Object$getPrototypeO = Object.getPrototypeOf(SystemMenu)).call.apply(_Object$getPrototypeO, [this].concat(args))), _this), _this.state = {
	            showModal: false,
	            menus: [],
	            gData: [],
	            ...
	            // });
	        }, _this.findNodeByKey = function (data, key, callback) {
	            data.forEach(function (item, index, arr) {
	                if (item.key === key) {
	                    return callback(item, index, arr);
	                }
	                if (item.children) {
	                    return _this.findNodeByKey(item.children, key, callback);
	                }
	            });
	            ...
	            var dragObj = void 0;
	            _this.findNodeByKey(data, dragKey, function (item, index, arr) {
	                arr.splice(index, 1);
	                dragObj = item;
	            });
	            if (info.dropToGap) {
	                var ar = void 0;
	                var i = void 0;
	                _this.findNodeByKey(data, dropKey, function (item, index, arr) {
	                ...
	                _this.findNodeByKey(data, dropKey, function (item) {
	        ...
	        }, _this.handleTreeNodeClick = function (selectedKeys) {
	            var data = [].concat(_toConsumableArray(_this.state.gData));
	            var selectedKey = selectedKeys[0];
	            var selectNodeData = void 0;
	            _this.findNodeByKey(data, selectedKey, function (item) {
	                selectNodeData = item;
	            });
	            ...
	            _this.setState({
	                gData: convertToTree(_this.state.menus)
	            });
	        }, _this.handleSubmit = function (e) {
	            e.preventDefault();
	            _this.props.form.validateFields(['key', 'text', 'icon', 'path'], function (errors, values) {
	                if (!!errors) {
	                    return;
	                }
	                var data = [].concat(_toConsumableArray(_this.state.gData));
	                _this.findNodeByKey(data, values.key, function (item) {
	            ...
	            loop(data);
	            _this.request().post('/system/menus').params({ menus: painData }).success(function () /* data, res */{
	            ...
	            _this.props.form.validateFields(['key'], function (errors, values) {
	                if (!!errors) {
	                    return;
	                }
	                var key = values.key;
	        ...
	        }, _this.handleFunctionDelete = function (functionKey) {
	            _this.props.form.validateFields(['key'], function (errors) {
	                if (!!errors) {
	                    return;
	                }
	                var data = [].concat(_toConsumableArray(_this.state.gData));
	                var loop = function loop(d) {
	                    d.forEach(function (v) {
	                        if (v.functions && v.functions.length) {
	                            v.functions.forEach(function (f, index, array) {
	        ...
	        }, _this.handleAddTopMenu = function () {
	            var setFieldsValue = _this.props.form.setFieldsValue;
	            ...
	            _this.showModal();
	        }, _this.handleAddFunction = function () {
	            _this.props.form.validateFields(['key'], function (errors) {
	                if (!!errors) {
	                    return;
	                }
	                ...
	                _this.showFunctionModal();
	            });
	        }, _this.handleAddSubmit = function () {
	            _this.props.form.validateFields(['newKey', 'newText', 'newIcon', 'newPath'], function (errors, values) {
	                if (!!errors) {
	                    return;
	                }
	                var data = [].concat(_toConsumableArray(_this.state.gData));
	                var parentKey = _this.props.form.getFieldValue('key');
	                var newNode = {
	                    parentKey: parentKey,
	                    key: values.newKey,
	                    text: values.newText,
	                ...
	                if (_this.state.isAddTopMenu) {
	                    newNode.parentKey = undefined;
	                    data.push(newNode);
	                } else {
	                    _this.findNodeByKey(data, parentKey, function (item) {
	                        if (!item.children) {
	                            item.children = [];
	                        }
	        ...
	        }, _this.handleAddFunctionSubmit = function () {
	            _this.props.form.validateFields(['functionKey', 'functionName', 'functionDescription'], function (errors, values) {
	                if (!!errors) {
	                    return;
	                }
	                var data = [].concat(_toConsumableArray(_this.state.gData));
	                ...
	                _this.hideFunctionModal();
	            });
	        }, _this.showModal = function () {
	            _this.setState({ showModal: true });
	        }, _this.hideModal = function () {
	            _this.setState({ showModal: false });
	        }, _this.showFunctionModal = function () {
	            _this.setState({ showFunctionModal: true });
	        }, _this.hideFunctionModal = function () {
	            _this.setState({ showFunctionModal: false });
	        }, _this.nodeExists = function (rule, value, callback) {
	            if (!value) {
	                callback();
	            } else {
	                var data = [].concat(_toConsumableArray(_this.state.gData));
	                var isFind = false;
	                _this.findNodeByKey(data, value, function () {
	                    isFind = true;
	                });
	                if (isFind) {
	        ...
	        }, _this.functionExists = function (rule, value, callback) {
	            if (!value) {
	                callback();
	            } else {
	                (function () {
	                    ...
	                    var loop = function loop(d) {
	                        d.forEach(function (v) {
	                            if (v.functions && v.functions.length) {
	                                v.functions.forEach(function (f) {
	                                    if (f.key === value) {
	                                        isFind = true;
	                                    }
	                                });
	    ...
	    _createClass(SystemMenu, [{
	        ...
	        value: function componentWillMount() {
	            ...
	            this.request().get('/system/menus').success(function (data) {
	                var defaultMenu = {
	                    key: 'super',
	                    parentKey: undefined,
	                    text: '未设置',
	        ...
	        value: function render() {
	                        ...
	                        return _react2.default.createElement(
	                            TreeNode,
	                            {
	                                ...
	                                title: _react2.default.createElement(
	                                    'span',
	                                    null,
	                                    _react2.default.createElement(_component.FAIcon, { type: item.icon }),
	                                    ' ',
	                                    item.text
	                                )
	                            },
	            ...
	            var newKeyFieldProps = {
	                rules: [{ required: true, message: 'key 不能为空！' }, { validator: this.nodeExists }]
	            };
	            var textFieldProps = {
	                rules: [{ required: true, min: 2, message: '标题至少为 2 个字符' }]
	            };
	            var iconFieldProps = {
	                rules: [
	            ...
	            var keyProps = getFieldProps('key', keyFieldProps);
	            var newKeyProps = getFieldProps('newKey', newKeyFieldProps);

	            var textProps = getFieldProps('text', textFieldProps);
	            var newTextProps = getFieldProps('newText', textFieldProps);

	            var iconProps = getFieldProps('icon', iconFieldProps);
	            var newIconProps = getFieldProps('newIcon', iconFieldProps);

	            var pathProps = getFieldProps('path', pathFieldProps);
	            var newPathProps = getFieldProps('newPath', pathFieldProps);

	            var functionKeyProps = getFieldProps('functionKey', {
	                rules: [{ required: true, message: 'key 不能为空！' }, { validator: this.functionExists }]
	            });
	            var functionNameProps = getFieldProps('functionName', {
	                rules: [{ required: true, message: '名称 不能为空！' }]
	            });
	            var functionDescriptionProps = getFieldProps('functionDescription', {});
	            ...
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(_antd.Alert, { message: '菜单存在Storage.session中，修改该保存之后，重新登陆会获取最新菜单。 菜单数据的key，唯一不可重复，有可能和权限关联，添加后不可修改。', type: 'warning', showIcon: true }),
	                _react2.default.createElement(
	                    _antd.Row,
	                    null,
	                    _react2.default.createElement(
	                        ...
	                        _react2.default.createElement(
	                            ...
	                            _react2.default.createElement(
	                                ...
	                                _react2.default.createElement(
	                                    _antd.Button,
	                                    { type: 'primary', size: 'large', onClick: this.handleAddTopMenu },
	                                    '添加顶级菜单'
	                                ),
	                                '   ',
	                                _react2.default.createElement(
	                                    _antd.Button,
	                                    { type: 'primary', size: 'large', onClick: this.handleSave },
	                                    '保存'
	                                ),
	                                '   ',
	                                _react2.default.createElement(
	                                    _antd.Button,
	                                    { type: 'ghost', size: 'large', onClick: this.handleReset },
	                                    '重置'
	                                )
	                            ),
	                            _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        ...
	                        _react2.default.createElement(
	                            ...
	                            _react2.default.createElement(
	                                ...
	                                _react2.default.createElement(
	                                    _antd.Button,
	                                    { type: 'ghost', onClick: this.handleAddChild },
	                                    '添加子节点'
	                                )
	                            ),
	                            _react2.default.createElement(
	                                ...
	                                _react2.default.createElement(_antd.Input, _extends({}, keyProps, {
	                            ...
	                            _react2.default.createElement(
	                                ...
	                                _react2.default.createElement(_antd.Input, _extends({}, textProps, {
	                                    onChange: function onChange(e) {
	                            ...
	                            _react2.default.createElement(
	                                ...
	                                _extends({}, formItemLayout, {
	                                    label: '图标：',
	                                    hasFeedback: true }),
	                                _react2.default.createElement(_antd.Input, _extends({}, iconProps, {
	                                    onChange: function onChange(e) {
	                            ...
	                            _react2.default.createElement(
	                                ...
	                                _extends({}, formItemLayout, {
	                                    label: '路径：',
	                                    hasFeedback: true }),
	                                _react2.default.createElement(_antd.Input, _extends({}, pathProps, {
	                                    onChange: function onChange(e) {
	                        ...
	                        _react2.default.createElement(_antd.Table, {
	                            ...
	                            columns: [{
	                                ...
	                                render: function render(text, record) {
	                                    ...
	                                    return _react2.default.createElement(
	                                        _antd.Popconfirm,
	                                        { title: '您确定要删除“' + record.name + '”？', onConfirm: function onConfirm() {
	                                                return _this3.handleFunctionDelete(key);
	                                            } },
	                                        _react2.default.createElement(
	                                            'a',
	                                            { href: '#' },
	                ...
	                _react2.default.createElement(
	                    _antd.Modal,
	                    { title: '添加子节点', visible: this.state.showModal, onOk: this.handleAddSubmit, onCancel: this.hideModal },
	                    _react2.default.createElement(
	                        _antd.Form,
	                        { horizontal: true, form: this.props.form },
	                        _react2.default.createElement(
	                            ...
	                            _react2.default.createElement(_antd.Input, _extends({}, newKeyProps, {
	                        ...
	                        _react2.default.createElement(
	                            ...
	                            _react2.default.createElement(_antd.Input, _extends({}, newTextProps, {
	                                placeholder: '菜单标题，必填'
	                            }))
	                        ),
	                        _react2.default.createElement(
	                            ...
	                            _extends({}, formItemLayout, {
	                                label: '图标：',
	                                hasFeedback: true }),
	                            _react2.default.createElement(_antd.Input, _extends({}, newIconProps, {
	                                placeholder: '菜单的icon，选填'
	                            }))
	                        ),
	                        _react2.default.createElement(
	                            ...
	                            _extends({}, formItemLayout, {
	                                label: '路径：',
	                                hasFeedback: true }),
	                            _react2.default.createElement(_antd.Input, _extends({}, newPathProps, {
	                                placeholder: '菜单跳转路径'
	                            }))
	                        )
	                    )
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        ...
	                        _react2.default.createElement(
	                            ...
	                            _react2.default.createElement(_antd.Input, _extends({}, functionKeyProps, {
	                                placeholder: '唯一不可重复！'
	                            }))
	                        ),
	                        _react2.default.createElement(
	                            ...
	                            _react2.default.createElement(_antd.Input, _extends({}, functionNameProps, {
	                                placeholder: '功能名称'
	                            }))
	                        ),
	                        _react2.default.createElement(
	                            ...
	                            _extends({}, formItemLayout, {
	                                label: '描述：',
	                                hasFeedback: true }),
	                            _react2.default.createElement(_antd.Input, _extends({}, functionDescriptionProps, {
	                                placeholder: '功能描述'
	                            }))
	                        )
	                    )
	...
	exports.default = createForm()(SystemMenu);
	module.exports = exports['default'];
