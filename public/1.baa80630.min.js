...
/***/ function(module, exports, __webpack_require__) {
	...
	var UserEdit = function (_BaseComponent) {
	    _inherits(UserEdit, _BaseComponent);
	    ...
	    function UserEdit() {
	        ...
	        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_Object$getPrototypeO = Object.getPrototypeOf(UserEdit)).call.apply(_Object$getPrototypeO, [this].concat(args))), _this), _this.state = {
	            isSaving: false,
	            orgData: [],
	            roles: []
	            ...
	            var fields = ['name', 'loginname', 'email', 'mobile', 'gender', 'position', 'org_key', 'role_id', 'is_locked'];
	            _this.props.form.validateFieldsAndScroll(fields, function (errors, values) {
	                if (!!errors) {
	                    return;
	                }
	                _this.setState({
	                ...
	                var id = _this.props.user && _this.props.user._id;
	                if (id) {
	                    // 存在id，是修改操作
	                    request.put(url);
	                    values._id = id;
	                ...
	                request.params(values).success(function () {
	    ...
	    _createClass(UserEdit, [{
	        ...
	        value: function componentWillMount() {
	            ...
	            this.request().get('/organization/organizations').success(function (data) {
	                if (data && data.length) {
	                    var organizations = data.map(function (v) {
	                        v.text = v.name;
	                        v.label = v.name;
	                        v.value = v.key;
	                        return v;
	            ...
	            this.request().get('/organization/roles').success(function (result) {
	        ...
	        value: function render() {
	            ...
	            var nameProps = getFieldProps('name', { initialValue: user.name });
	            var loginnameProps = getFieldProps('loginname', {
	                initialValue: user.loginname,
	                rules: [_common.ValidationRule.required('登录名'), _common.ValidationRule.loginName(), _common.ValidationRule.checkLoginNameExist(ignoreValues)]
	            });
	            var emailProps = getFieldProps('email', {
	                initialValue: user.email,
	                rules: [_common.ValidationRule.email()]
	            });
	            var mobileProps = getFieldProps('mobile', {
	                initialValue: user.mobile,
	                rules: [_common.ValidationRule.mobile()]
	            });
	            var genderProps = getFieldProps('gender', {
	                initialValue: user.gender,
	                rules: []
	            });
	            var positionProps = getFieldProps('position', {
	                initialValue: user.position,
	                rules: []
	            });
	            var roleProps = getFieldProps('role_id', {
	                initialValue: user.role_id,
	                rules: [_common.ValidationRule.required('角色')]
	            });
	            var orgProps = getFieldProps('org_key', {
	                initialValue: user.org_key,
	                rules: []
	            });
	            var isLockedProps = getFieldProps('is_locked', {
	            ...
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        ...
	                        _react2.default.createElement(
	                            ...
	                            _react2.default.createElement(
	                                ...
	                                _react2.default.createElement(_antd.Input, _extends({}, loginnameProps, {
	                                    placeholder: '请输入登录名'
	                                }))
	                            )
	                        ),
	                    ...
	                    _react2.default.createElement(
	                        ...
	                        _react2.default.createElement(
	                            ...
	                            _react2.default.createElement(
	                                ...
	                                _react2.default.createElement(_antd.Input, _extends({}, emailProps, {
	                                    placeholder: '请输入邮箱'
	                                }))
	                            )
	                        ),
	                        _react2.default.createElement(
	                            ...
	                            _react2.default.createElement(
	                                ...
	                                _react2.default.createElement(_antd.Input, _extends({}, mobileProps, {
	                                    placeholder: '请输入电话'
	                                }))
	                            )
	                        )
	                    ...
	                    _react2.default.createElement(
	                        ...
	                        _extends({}, formItemLayout, {
	                            label: '所属部门：' }),
	                        _react2.default.createElement(_antd.TreeSelect, _extends({
	                    ...
	                    _react2.default.createElement(
	                        ...
	                        _extends({}, formItemLayout, {
	                            label: '职位：' }),
	                        _react2.default.createElement(_antd.Input, _extends({}, positionProps, {
	                            placeholder: '请输入职位'
	                        }))
	                    ),
	                    _react2.default.createElement(
	                        ...
	                        _react2.default.createElement(
	                            ...
	                            this.state.roles.map(function (r) {
	                                return _react2.default.createElement(
	                                    Option,
	                                    { key: r._id, value: r._id },
	                                    r.name
	                                );
	                            })
	                        )
	                    ...
	                    _react2.default.createElement(
	                        ...
	                        _extends({}, formItemLayout, {
	                            label: '锁定：' }),
	                        _react2.default.createElement(_antd.Switch, _extends({}, isLockedProps, {
	                            checkedChildren: '是',
	                            unCheckedChildren: '否'
	                        }))
	                    )
	...
	exports.default = createForm()(UserEdit);
	module.exports = exports['default'];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _UserEdit = __webpack_require__(210);
	...
	var UserList = function (_BaseComponent) {
	    ...
	    function UserList() {
	        ...
	        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_Object$getPrototypeO = Object.getPrototypeOf(UserList)).call.apply(_Object$getPrototypeO, [this].concat(args))), _this), _this.state = {
	            queryData: {
	                currentPage: 1,
	                pageSize: 10
	            },
	            ...
	            onSubmit: function onSubmit(data) {
	                var queryData = (0, _objectAssign2.default)({}, _this.state.queryData, data, { currentPage: 1 });
	                _this.setState({
	                    queryData: queryData
	                });
	                _this.handleSearch(queryData);
	            },
	            items: [[{
	                type: 'input',
	                name: 'loginname',
	            ...
	            render: function render(text) {
	                var orgName = '未指定';
	                _state$organizations = _this.state.organizations;

	                if (!(_state$organizations && typeof _state$organizations[Symbol.iterator] === 'function')) {
	                    throw new TypeError('Expected _state$organizations to be iterable, got ' + (_state$organizations === null ? 'null' : (typeof _state$organizations === 'undefined' ? 'undefined' : _typeof(_state$organizations)) === 'object' && _state$organizations.constructor ? _state$organizations.constructor.name || '[Unknown Object]' : typeof _state$organizations === 'undefined' ? 'undefined' : _typeof(_state$organizations)));
	                }
	                ...
	                try {
	                    for (var _iterator = _state$organizations[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
	                        var _state$organizations;
	            ...
	            key: 'role',
	            render: function render(text) {
	                var role = _this.state.roles.find(function (r) {
	                    return r._id === text;
	                });
	                if (role) {
	                    return role.name;
	            ...
	            render: function render(text, record) {
	                var id = record._id;
	                return _react2.default.createElement(_component.SwitchRemote, {
	                    ...
	                    onChange: function onChange(checked) {
	                        return record.is_locked = checked;
	                    } // 同步record，否则下次页面重新渲染，选中状态会错乱。
	                });
	            }
	        }, {
	            title: '操作',
	            ...
	            render: function render(text, record) {
	                var id = record._id;
	                var dealing = _react2.default.createElement(
	                    'span',
	                    { style: { padding: '0px 6px' } },
	                    _react2.default.createElement(_antd.Icon, { type: 'loading' })
	                );
	                var deleteText = _this.state.deletingId === id ? dealing : '删除';
	                var editText = _this.state.editingUserId === id ? dealing : '编辑';
	                var resetPassText = _this.state.resetPassId === id ? dealing : '重置密码';
	                return _react2.default.createElement(
	                    'div',
	                    null,
	                    _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        _antd.Popconfirm,
	                        { placement: 'topRight', title: '您确定要删除“' + record.name + '”？', onConfirm: function onConfirm() {
	                    ...
	                    _react2.default.createElement(
	                        _antd.Popconfirm,
	                        { placement: 'topRight', title: '您确定要重置“' + record.name + '”的密码吗？', onConfirm: function onConfirm() {
	                                return _this.handleResetPass(id);
	                            } },
	                        _react2.default.createElement(
	                            'a',
	                            { href: '#' },
	            ...
	            var queryData = arguments.length <= 0 || arguments[0] === undefined ? _this.state.queryData : arguments[0];

	            queryData.size = queryData.pageSize;
	            queryData.offset = (queryData.currentPage - 1) * queryData.pageSize;
	            _this.request().get('/organization/users').params(queryData).success(function (data) {
	            ...
	            _this.request().del('/organization/users').params({ id: id }).success(function () {
	        ...
	        }, _this.handleResetPass = function (id) {
	            if (_this.state.resetPassId) {
	                return;
	            }
	            ...
	            _this.request().put('/organization/users/reset_pass').params({ id: id }).success(function () {
	            ...
	            _this.request().get('/organization/users/' + id).success(function (data) {
	                _this.setState({
	                    editingUser: data
	                });
	                _this.showEditModal();
	    ...
	    _createClass(UserList, [{
	        ...
	        value: function render() {
	            ...
	            var paginationOptions = {
	                ...
	                onChange: function onChange(currentPage, pageSize) {
	                    var queryData = (0, _objectAssign2.default)({}, _this3.state.queryData, { currentPage: currentPage, pageSize: pageSize });
	                    _this3.setState({
	                        queryData: queryData
	                    });
	                    _this3.handleSearch(queryData);
	                }
	            };
	            return _react2.default.createElement(
	                _framework.Page,
	                { header: 'auto', loading: this.state.loading },
	                _react2.default.createElement(_component.QueryTerms, { options: this.queryOptions }),
	                _react2.default.createElement(
	                    _component.ToolBar,
	                    null,
	                    _react2.default.createElement(
	                ...
	                _react2.default.createElement(_component.PaginationComponent, { options: paginationOptions }),
	...
	exports.default = createForm()(UserList);
	module.exports = exports['default'];
