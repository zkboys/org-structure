...
/***/ function(module, exports, __webpack_require__) {
	...
	var Index = function (_React$Component) {
	    ...
	    function Index() {
	        ...
	        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_Object$getPrototypeO = Object.getPrototypeOf(Index)).call.apply(_Object$getPrototypeO, [this].concat(args))), _this), _this.state = {
	            toc: [],
	            contents: []
	        }, _this.components = [{
	    ...
	    _createClass(Index, [{
	        ...
	        value: function componentWillMount() {
	            ...
	            this.components.forEach(function (item, index) {
	                toc.push(_react2.default.createElement(
	                    'li',
	                    { key: 'toc-' + index },
	                    _react2.default.createElement(
	                        'a',
	                ...
	                contents.push(_react2.default.createElement(
	                    ...
	                    _this2.readMe(item.folder),
	                    _this2.demo(item.folder)
	                ));
	            });
	            this.setState({
	                toc: toc,
	        ...
	        key: 'readMe',
	        value: function readMe(folder) {
	            var readMeMarkDown = __webpack_require__(287)("./" + folder + '/README.md');
	        ...
	        key: 'demo',
	        value: function demo(folder) {
	            var Demo = __webpack_require__(286)("./" + folder + '/Demo.jsx');
	            return _react2.default.createElement(
	                'div',
	                { className: 'demo-body' },
	                _react2.default.createElement(
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    'div',
	                    { style: { position: 'fixed', right: 60, top: 80, zIndex: 99 } },
	                    _react2.default.createElement(
	                        'h1',
	                        null,
	                        '目录'
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Demo = function (_React$Component) {
	    ...
	    function Demo() {
	        ...
	        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_Object$getPrototypeO = Object.getPrototypeOf(Demo)).call.apply(_Object$getPrototypeO, [this].concat(args))), _this), _this.state = {}, _temp), _possibleConstructorReturn(_this, _ret);
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Demo = function (_BaseComponent) {
	    ...
	    function Demo() {
	        ...
	        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_Object$getPrototypeO = Object.getPrototypeOf(Demo)).call.apply(_Object$getPrototypeO, [this].concat(args))), _this), _this.state = {}, _this.handleReset = function (e) {
	            e.preventDefault();
	            // FIXME 自定义组件reset无效
	    ...
	    _createClass(Demo, [{
	        ...
	        value: function render() {
	            ...
	            var radioProps = getFieldProps('radio', {
	                rules: [{ required: true, message: '选择一个！' }]
	            });
	            var comboboxProps = getFieldProps('combobox', {
	            ...
	            var checkboxprops = getFieldProps('checkbox', {
	                rules: [
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        ...
	                        _extends({}, formItemLayout, {
	                            label: '单选：' }),
	                        _react2.default.createElement(_index.RadioItem, _extends({
	                            button: true,
	                            size: 'large',
	                    ...
	                    _react2.default.createElement(
	                        ...
	                        _extends({}, formItemLayout, {
	                            label: '多选：' }),
	                        _react2.default.createElement(_index.CheckBoxItem, _extends({
	                            button: true,
	                            size: 'large',
	                            url: '/api/m/1/stores.json',
	                            expandable: true,
	                    ...
	                    _react2.default.createElement(
	                        ...
	                        _react2.default.createElement(_index.ComboboxItem, _extends({
	                            ...
	                            defaultValue: 'all',
	                            separator: '@',
	                            options: ['163.com', 'qq.com', '126.com', 'xx.com'],
	                            style: { width: '200px' },
	                            optionsFilter: function optionsFilter(res) {
	                                // 对ajax返回的数据进行处理
	                                return res.body.results.map(function (v) {
	                    ...
	                    _react2.default.createElement(
	                        ...
	                        _extends({}, formItemLayout, {
	                            label: '日期区间：' }),
	                        _react2.default.createElement(_index.DateTimeAreaItem, {
	                            dateArea: true,
	...
	var Demo = function (_React$Component) {
	    ...
	    _createClass(Demo, [{
	        ...
	        value: function render() {
	            ...
	            return _react2.default.createElement(_PaginationComponent2.default, { options: options });
	        }
	    }]);
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        'div',
	                        { className: 'content', style: { padding: '10px' } },
	                        _react2.default.createElement(
	                            'table',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Demo = function (_React$Component) {
	    ...
	    _createClass(Demo, [{
	        ...
	        value: function render() {
	            var options = {
	                onChange: function onChange(data) {// 可选 元素onchange后触发，data为所有得元素数据
	                },
	                onDidMount: function onDidMount(data) {}, //可选，查询组件DidMount之后，会触发，data为初始化时，各个元素的值。
	                ...
	                onSubmit: function onSubmit(data) {
	                    // 必选，点击查询按钮时的回调函数 data为所有的查询条件数据，可以在这个函数中发起请求等操作。
	                    console.log('***', data);
	                },
	                items: [
	                // 如果是对象，自己占据一行， 如果是数组，数组中所有的组件共占一行
	                {
	                    ...
	                    options: [{ value: 'tab1', label: 'Tab页1' }, { value: 'tab2', label: 'Tab页2' }, { value: 'tab3', label: 'Tab页3' }, { value: 'tab4', label: 'Tab页4' }]
	                }, {
	                    ...
	                    { value: 'all', label: '全部' }, { value: '1', label: '和平门' }, { value: '2', label: '前门大街' }, { value: '3', label: '东直门' }, { value: '4', label: '宋家庄' }]
	                }, {
	                    type: 'inputNumber',
	                    name: 'number',
	                    label: '数字',
	                    ...
	                    options: [{ value: '11', label: '中国' }, { value: '22', label: '美国' }, { value: '33', label: '俄罗斯' }, { value: '44', label: '加拿大' }]
	                }, {
	                    type: 'checkboxButton',
	                    ...
	                    options: [{ value: 'all', label: '全部' }, { value: '11', label: '中国' }, { value: '22', label: '美国' }, { value: '33', label: '俄罗斯' }]
	                },
	                ...
	                // {value: '117', label: '加拿大117'},
	                {
	                    ...
	                    options: [{ value: 1, label: '单选一' }, { value: 2, label: '单选二' }, { value: 3, label: '单选三' }, { value: 4, label: '单选四' }]
	                }, {
	                    type: 'radioButton',
	                    name: 'radioButton',
	                    label: '单选按钮',
	                    ...
	                    options: [{ value: 'all', label: '全部' }, { value: 1, label: '单选一', disabled: true }, { value: 2, label: '单选二' }, { value: 3, label: '单选三' }, { value: 4, label: '单选四' }]
	                }, {
	                    type: 'radioButton',
	                    name: 'radioButton2',
	                    label: '可收展单选按钮',
	                    ...
	                    options: [{ value: 'all', label: '全部' }, { value: 1, label: '单选一' }, { value: 2, label: '单选二' }, { value: 3, label: '单选三' }, { value: 4, label: '单选四' }, { value: 5, label: '单选五' }, { value: 6, label: '单选六' }, { value: 7, label: '单选七' }, { value: 8, label: '单选八' }, { value: 9, label: '单选九' }, { value: 10, label: '单选十' }, { value: 11, label: '单选十一' }, { value: 12, label: '单选十二' }, { value: 13, label: '单选十三' }, { value: 14, label: '单选十四' }, { value: 15, label: '单选十五' }, { value: 16, label: '单选十六' }, { value: 17, label: '单选十七' }, { value: 18, label: '单选十八' }, { value: 19, label: '单选十九' }]
	                }, [{
	                    type: 'select',
	                    name: 'selectName',
	                    label: '普通下拉',
	                    defaultValue: '112',
	                    options: [{ value: '111', label: '中国' }, { value: '112', label: '中国1' }, { value: '113', label: '中国2' }, { value: '22', label: '美国3' }, { value: '33', label: '俄罗斯' }, { value: '44', label: '加拿大' }]
	                }, {
	                    type: 'selectSearch',
	                    name: 'selectUrlName',
	                    label: '异步下拉',
	                    ...
	                    label: '搜索下拉',
	                    defaultValue: '112',
	                    options: [{ value: '11', label: '中国' }, { value: '111', label: '中国1' }, { value: '112', label: '中国2' }, { value: '113', label: '中国3' }, { value: '22', label: '美国' }, { value: '33', label: '俄罗斯' }, { value: '44', label: '加拿大' }]
	                }, {
	                    type: 'selectMultiple',
	            ...
	            return _react2.default.createElement(_QueryTerms2.default, { options: options });
	        }
	    }]);
	...
	var Demo = function (_React$Component) {
	    ...
	    _createClass(Demo, [{
	        ...
	        value: function render() {
	            ...
	            var id = record.id;
	            var isLocked = record.is_locked;
	            return _react2.default.createElement(
	                'div',
	                null,
	                _react2.default.createElement(_SwitchRemote2.default, {
...
/***/ function(module, exports) {
	...
	module.exports = "<h1 id=\"-\">组件基类</h1>\n<p>所有的业务要继承BaseComponent，BaseComponent封装了一些公共处理</p>\n<h2 id=\"-\">功能</h2>\n<h3 id=\"-\">获取当前登录用户</h3>\n<pre><code>this.currentUser;\n</code></pre><h3 id=\"-\">当前用户权限检测</h3>\n<pre><code>this.currentUser.hasPermission(&#39;user-update&#39;);\n</code></pre><h3 id=\"-loading\">全屏loading</h3>\n<pre><code>this.startLoading();\nthis.endLoading();\n</code></pre><h3 id=\"request-\">request封装，链式调用</h3>\n<ol>\n<li>自动startLoading,endLoading</li>\n<li>自动处理异常：服务端返回异常，断网异常，超时异常</li>\n<li>自动根据约定处理返回结果</li>\n</ol>\n<pre><code>this.request()\n.get(url)\n.timeout(1000*10) // 设置超时时间，默认是10秒\n.params({}) // 内部会区分，get请求使用query，post，put，del请求使用send\n.noLoading() // 不会调用全屏loading，如果需要自己处理loading，会用到此函数\n.setErrorMsg(errorMsg) // 自定义错误提示信息，否则内部会自动尝试给出错误提示\n.start(cb) // ajax开始之间的回调函数 cb:function()\n.error(cb) // 出错时回调函数 cb:functin(err, res)\n.success(cb) // 成功回调，尝试根据约定处理结果（result results约定），如果结果不是自己想要的，可以从res中获取，cb:function(result || results || res.body || res, res)\n.end(cb) // 以上方法只是在做准备，end函数才真正根据前面得准备发送请求。所以一定要调用end。cb可选，cb:function(err, res)\n</code></pre><h3 id=\"-\">组件卸载，自动打断未结束请求</h3>\n<pre><code>componentWillUnmount() {\n        // 组件卸载之后，打断所有未结束得请求，\n        // 子类要是要使用componentWillUnmount，需要显示的调用super().componentWillUnmount();\n        this.requests.forEach(r =&gt; {\n            r.abort();\n        });\n    }\n</code></pre>";

/***/ },
/* 239 */
/***/ function(module, exports) {

	module.exports = "<h1 id=\"-\">列表页面封装</h1>\n<p>列表页面使用频率比较高，封装之后，基本上通过一个json就可以配置出整个页面，提高开发效率；\n特殊需求的页面，可以考虑参考ListPage.jsx的写法，自己组装各个组件。</p>\n<p>## </p>\n";

/***/ },
/* 240 */
/***/ function(module, exports) {

	module.exports = "<h1 id=\"-\">分页封装</h1>\n<h2 id=\"-demo-jsx\">代码是最好的文档，请查看Demo.jsx</h2>\n";

/***/ },
/* 241 */
/***/ function(module, exports) {

	module.exports = "<h1 id=\"-\">面板组件</h1>\n<h2 id=\"api\">API</h2>\n<table>\n<thead>\n<tr>\n<th>属性</th>\n<th>必填</th>\n<th>说明</th>\n<th>类型</th>\n<th>默认值</th>\n</tr>\n</thead>\n<tbody>\n<tr>\n<td>header</td>\n<td>是</td>\n<td>头部</td>\n<td>string / object / array</td>\n<td><code>[{title: &#39;默认标题&#39;,subTitle: &#39;默认副标题&#39;,}]</code></td>\n</tr>\n<tr>\n<td>width</td>\n<td>否</td>\n<td>宽度</td>\n<td>string/number</td>\n<td>&#39;100%&#39;</td>\n</tr>\n</tbody>\n</table>\n";

/***/ },
/* 242 */
/***/ function(module, exports) {

	module.exports = "<h1 id=\"-\">查询条件封装</h1>\n<h2 id=\"-demo-jsx\">代码是最好的文档，请查看Demo.jsx</h2>\n<h2 id=\"-\">注意事项</h2>\n<ul>\n<li>不提供type=customer，自定义条件不好控制，如果发现封装好的条件不能满足需求，需要一个其他类型的查询条件，请联系相关人员进行补充。</li>\n</ul>\n";

/***/ },
/* 243 */
/***/ function(module, exports) {

	module.exports = "<h1 id=\"switchremote-\">SwitchRemote 远程开关</h1>\n<p>切换某个属性得状态，比如锁定/解锁（true/false），发起远程请求，请求过程中，Switch为loading状态，并且不可用，切换结束之后，才可以进行下一次点击。</p>\n<h2 id=\"api\">API</h2>\n<table>\n<thead>\n<tr>\n<th>属性</th>\n<th>必填</th>\n<th>说明</th>\n<th>类型</th>\n<th>默认值</th>\n</tr>\n</thead>\n<tbody>\n<tr>\n<td>checked</td>\n<td>是</td>\n<td>开启状态，true为开启，false为关闭</td>\n<td>bool</td>\n<td>false</td>\n</tr>\n<tr>\n<td>url</td>\n<td>是</td>\n<td>请求后台的url，由于状态切换属于修改操作，所以使用put发送请求</td>\n<td>string</td>\n<td>-                       </td>\n</tr>\n<tr>\n<td>checkedKey</td>\n<td>是</td>\n<td>要切换的数据key，后端会接受此参数</td>\n<td>string</td>\n<td>-                       </td>\n</tr>\n<tr>\n<td>params</td>\n<td>否</td>\n<td>请求参数，比如id等</td>\n<td>object</td>\n<td>-                    </td>\n</tr>\n<tr>\n<td>onChange</td>\n<td>否</td>\n<td>状态改变触发</td>\n<td>function(checked)</td>\n<td>-</td>\n</tr>\n<tr>\n<td>checkedChildren</td>\n<td>否</td>\n<td>开启式显示文字</td>\n<td>string/jsx</td>\n<td>&quot;是&quot;                    </td>\n</tr>\n<tr>\n<td>unCheckedChildren</td>\n<td>否</td>\n<td>关闭显示文字</td>\n<td>string/jsx</td>\n<td>&quot;否&quot;  </td>\n</tr>\n</tbody>\n</table>\n<h2 id=\"-\">说明</h2>\n<ol>\n<li>url对应的后台接口对状态进行切换，如果checkedKey对应参数传入true，数据库对应数据状态改为false，如果checkedKey对应参数传入false，数据库对应数据状态改为true</li>\n<li>表格中使用是，一定要加上key，否则多页之间有干扰</li>\n<li>要通过onChange改变数据状态，否则页面重新渲染之后，Switch状态会不准确。                    </li>\n</ol>\n";

/***/ },
/* 244 */
/***/ function(module, exports) {

	module.exports = "<h1 id=\"-\">工具条封装</h1>\n<p>就是一个div，应用了如下样式，使内部直接子节点，全部间距10px</p>\n<pre><code class=\"lang-less\">.default-tool-bar {\n    &amp; &gt; * {\n        margin-right: 10px;\n    }\n}\n</code></pre>\n";
...
/***/ function(module, exports, __webpack_require__) {
	...
	var map = {
		"./base-component/Demo.jsx": 185,
		"./form-item/Demo.jsx": 186,
		"./pagination/Demo.jsx": 187,
		"./panel/Demo.jsx": 188,
		"./query-terms/Demo.jsx": 189,
		"./switch-remote/Demo.jsx": 190
	};
	function webpackContext(req) {
		return __webpack_require__(webpackContextResolve(req));
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var map = {
		"./base-component/README.md": 238,
		"./list-page/README.md": 239,
		"./pagination/README.md": 240,
		"./panel/README.md": 241,
		"./query-terms/README.md": 242,
		"./switch-remote/README.md": 243,
		"./tool-bar/README.md": 244
	};
	function webpackContext(req) {
		return __webpack_require__(webpackContextResolve(req));
	};
