...
/***/ function(module, exports, __webpack_require__) {
	...
	var ProfilePassWord = function (_React$Component) {
	    _inherits(ProfilePassWord, _React$Component);
	    ...
	    function ProfilePassWord() {
	        ...
	        _classCallCheck(this, ProfilePassWord);

	        for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
	            args[_key] = arguments[_key];
	        }

	        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_Object$getPrototypeO = Object.getPrototypeOf(ProfilePassWord)).call.apply(_Object$getPrototypeO, [this].concat(args))), _this), _this.state = {
	            loading: false
	            ...
	            _this.props.form.validateFields(function (errors, values) {
	                ...
	                _common.Request.put('/system/pass').send(values).end(function (err, res) {
	                    _this.setState({
	                        loading: false
	                    });
	                    if (err || !res.ok) {
	    ...
	    _createClass(ProfilePassWord, [{
	        key: 'render',
	        value: function render() {
	            var getFieldProps = this.props.form.getFieldProps;

	            var OrPasswdProps = getFieldProps('orPass', {
	                rules: [{ required: true, whitespace: true, message: '请填写原密码' }]
	            });
	            ...
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        ...
	                        _react2.default.createElement(_antd.Input, _extends({}, OrPasswdProps, {
	                            type: 'password',
	                            autoComplete: 'off',
	                            onContextMenu: noop,
	                            onPaste: noop,
	...
	exports.default = createForm()(ProfilePassWord);
	module.exports = exports['default'];
