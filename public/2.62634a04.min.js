...
/***/ function(module, exports, __webpack_require__) {
	...
	var createForm = _antd.Form.create;
	var FormItem = _antd.Form.Item;
	var systemMenuKey = 'system'; // 这里硬编码，系统级菜单，每个人都有权限，默认选中，并不可操作。

	var RoleEdit = function (_BaseComponent) {
	    _inherits(RoleEdit, _BaseComponent);
	    ...
	    function RoleEdit() {
	        ...
	        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_Object$getPrototypeO = Object.getPrototypeOf(RoleEdit)).call.apply(_Object$getPrototypeO, [this].concat(args))), _this), _this.state = {
	            isSaving: false,
	            gData: [],
	            defaultCheckedKeys: []
	            ...
	            var fields = ['name', 'description', 'permissions'];
	            _this.props.form.validateFieldsAndScroll(fields, function (errors, values) {
	                ...
	                var url = '/organization/roles';
	                var id = _this.props.role && _this.props.role._id;
	                if (id) {
	                    // 存在id，是修改操作
	                    request.put(url);
	                    values._id = id;
	            ...
	            data.forEach(function (item) {
	                ...
	                if (item.functions) {
	                    _item$functions = item.functions;

	                    if (!(_item$functions && typeof _item$functions[Symbol.iterator] === 'function')) {
	                        throw new TypeError('Expected _item$functions to be iterable, got ' + (_item$functions === null ? 'null' : (typeof _item$functions === 'undefined' ? 'undefined' : _typeof(_item$functions)) === 'object' && _item$functions.constructor ? _item$functions.constructor.name || '[Unknown Object]' : typeof _item$functions === 'undefined' ? 'undefined' : _typeof(_item$functions)));
	                    }
	                    ...
	                    try {
	                        for (var _iterator = _item$functions[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
	                            var _item$functions;
	        ...
	        }, _this.onCheck = function (info, e) {
	            var checkedNodes = e.checkedNodes;
	            var permissions = new Set();
	            if (checkedNodes && checkedNodes.length) {
	                checkedNodes.forEach(function (checkNode) {
	                    var key = checkNode.key;
	                    _this.findNodeByKey(_this.state.gData, key, function (node) {
	                        var keys = [].concat(_toConsumableArray(node.parentKeys));
	                        keys.push(key);
	    ...
	    _createClass(RoleEdit, [{
	        ...
	        value: function componentWillMount() {
	            ...
	            this.request().get('/system/menus').success(function (data) {
	                ...
	                var gData = convertToTree(menus);
	                gData = gData.filter(function (g) {
	                    return g.key !== 'dev';
	                });
	                ...
	                var loop = function loop(d) {
	                    return d.forEach(function (item) {
	                        ...
	                        if (item.functions && item.functions.length) {
	                            item.functions.forEach(function (v) {
	                                v.parentKeys = [].concat(_toConsumableArray(item.parentKeys));
	        ...
	        value: function render() {
	            ...
	            var loop = function loop(data) {
	                return data.map(function (item) {
	                    ...
	                    return _react2.default.createElement(TreeNode, _extends({}, disable, {
	                        key: item.key,
	                        title: _react2.default.createElement(
	                            'span',
	                            null,
	            ...
	            var nameProps = getFieldProps('name', {
	                ...
	                rules: [_common.ValidationRule.required('角色名'), _common.ValidationRule.checkRoleNameExist(ignoreValues)]
	            });
	            ...
	            var keys = role.permissions || [];
	            keys = keys.filter(function (v) {
	                var node = null;
	                _this3.findNodeByKey(_this3.state.gData, v, function (n) {
	                    node = n;
	                });
	...
	exports.default = createForm()(RoleEdit);
	module.exports = exports['default'];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _RoleEdit = __webpack_require__(208);

	var _RoleEdit2 = _interopRequireDefault(_RoleEdit);
	...
	var RoleList = function (_BaseComponent) {
	    _inherits(RoleList, _BaseComponent);
	    ...
	    function RoleList() {
	        ...
	        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_Object$getPrototypeO = Object.getPrototypeOf(RoleList)).call.apply(_Object$getPrototypeO, [this].concat(args))), _this), _this.state = {
	            queryData: {
	                currentPage: 1,
	                pageSize: 10
	            },
	            ...
	            render: function render(text, record) {
	                ...
	                var editText = _this.state.editingRoleId === id ? dealing : '编辑';
	                return _react2.default.createElement(
	                    'div',
	                    null,
	                    _react2.default.createElement(
	            ...
	            _this.request().get('/organization/roles').params(queryData).success(function (data) {
	            ...
	            _this.request().del('/organization/roles').params({ id: id }).success(function () {
	            ...
	            _this.request().get('/organization/roles/' + id).success(function (data) {
	                _this.setState({
	                    editingRole: data
	                });
	                _this.showEditModal();
	        ...
	        value: function render() {
	            ...
	            var paginationOptions = {
	                ...
	                onChange: function onChange(currentPage, pageSize) {
	                    var queryData = (0, _objectAssign2.default)({}, _this2.state.queryData, { currentPage: currentPage, pageSize: pageSize });
	                    _this2.setState({
	                        queryData: queryData
	                    });
	                    _this2.handleSearch(queryData);
	                }
	            };
	            return _react2.default.createElement(
	                _framework.Page,
	                ...
	                _react2.default.createElement(_RoleEdit2.default, {
	...
	exports.default = createForm()(RoleList);
	module.exports = exports['default'];
