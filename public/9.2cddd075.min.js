...
/***/ function(module, exports, __webpack_require__) {
	...
	var SettingsPage = function (_React$Component) {
	    ...
	    function SettingsPage() {
	        ...
	        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_Object$getPrototypeO = Object.getPrototypeOf(SettingsPage)).call.apply(_Object$getPrototypeO, [this].concat(args))), _this), _this.state = {
	            showPageAnimate: _Settings2.default.pageAnimate()
	        }, _this.handleShowPageAnimate = function () {
	            _this.setState({
	                showPageAnimate: !_this.state.showPageAnimate
	            });
	            _Settings2.default.pageAnimate(!_this.state.showPageAnimate);
	        }, _temp), _possibleConstructorReturn(_this, _ret);
	    }
	            ...
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        ...
	                        _react2.default.createElement(
	                            'label',
	                            { className: 'ant-checkbox-vertical', style: { cursor: 'pointer' } },
	                            _react2.default.createElement(_antd.Checkbox, { checked: this.state.showPageAnimate, onChange: this.handleShowPageAnimate }),
	                            '  启用页面切换动画'
	                        )
	                    )
	                )
