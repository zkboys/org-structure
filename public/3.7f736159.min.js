...
/***/ function(module, exports, __webpack_require__) {
	...
	var ProfileMessage = function (_BaseComponent) {
	    _inherits(ProfileMessage, _BaseComponent);
	    ...
	    function ProfileMessage() {
	        ...
	        _classCallCheck(this, ProfileMessage);

	        for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
	            args[_key] = arguments[_key];
	        }

	        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_Object$getPrototypeO = Object.getPrototypeOf(ProfileMessage)).call.apply(_Object$getPrototypeO, [this].concat(args))), _this), _this.state = {
	            isSaving: false,
	            user: {}
	            ...
	            _this.props.form.validateFieldsAndScroll(function (errors, values) {
	                ...
	                request.put('/system/message').params(values).success(function () {
	    ...
	    _createClass(ProfileMessage, [{
	        key: 'componentWillMount',
	        value: function componentWillMount() {
	            var _this2 = this;

	            var currentLoginUser = _common.Common.getCurrentLoginUser();
	            this.request().get('/organization/users/' + currentLoginUser._id).success(function (user) {
	                _this2.setState({
	                    user: user
	                });
	            }).end();
	        ...
	        value: function render() {
	            ...
	            var idProps = getFieldProps('_id', { initialValue: user._id });
	            ...
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        ...
	                        _react2.default.createElement(_antd.Input, _extends({}, idProps, {
	                            placeholder: '请输入登录名'
	                        }))
	                    ),
	                    _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        ...
	                        _react2.default.createElement(
	                            _antd.Button,
	                            { type: 'primary', loading: this.state.loading, onClick: this.handleSubmit },
	                            '确定'
	                        ),
	                        '   ',
	                        _react2.default.createElement(
	...
	exports.default = createForm()(ProfileMessage);
	module.exports = exports['default'];
