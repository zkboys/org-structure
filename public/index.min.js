...
/***/ function(module, exports, __webpack_require__) {
	...
	_reactDom2.default.render(_react2.default.createElement(_Routes2.default, null), document.getElementById('framework'));
	...
	var FAIcon = function (_React$Component) {
	    ...
	    _createClass(FAIcon, [{
	        ...
	        value: function render() {
	            var className = ['fa', this.props.type].join(' ');
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Router2 = __webpack_require__(262);
	...
	var _History2 = __webpack_require__(255);

	var _History3 = _interopRequireDefault(_History2);

	exports.History = _History3['default'];

	var _Lifecycle2 = __webpack_require__(259);
	...
	var _RouteUtils = __webpack_require__(149);
	...
	var _PropTypes2 = __webpack_require__(151);
...
/***/ function(module, exports, __webpack_require__) {
	...
	function getSetValue(key, value, defaultValue) {
	    if (value === undefined) {
	        var result = _storage2.default.local.get(key);
	        return result == null ? defaultValue : result;
	    }
	    _storage2.default.local.set(key, value);
	}
	exports.default = {
	    pageAnimate: function pageAnimate(value) {
	        return getSetValue('showPageAnimate', value, true);
	    },
	    collapseSidebar: function collapseSidebar(value) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.getCurrentSidebarMenu = exports.getSidebarMenus = undefined;
	...
	var _menus = __webpack_require__(166);

	var _menus2 = _interopRequireDefault(_menus);

	var _HeaderMenuUtil = __webpack_require__(196);

	var _common = __webpack_require__(152);
	...
	function getMenuJsx(node) {
	    var min = !!_Settings2.default.collapseSidebar();
	    var key = node.key;
	    var path = node.path;
	    var icon = node.icon;
	    var text = node.text;
	    if (node.children) {
	        return _react2.default.createElement(
	            ...
	            { key: key, title: _react2.default.createElement(
	                    'span',
	                    null,
	                    _react2.default.createElement(_FAIcon2.default, { type: icon }),
	    ...
	    var item = _react2.default.createElement(
	        ...
	        _react2.default.createElement(_FAIcon2.default, {
	            type: icon
	        }),
	        _react2.default.createElement(
	            'span',
	    ...
	    if (min && node.parentKeys.length === 1) {
	        // FIXME 这个判断有些不好。
	        item = _react2.default.createElement(
	            _antd.Tooltip,
	            { placement: 'right', title: _react2.default.createElement(
	                    _reactRouter.Link,
	                    { to: path, activeClassName: 'active', style: { color: '#fff' } },
	                    _react2.default.createElement(
	                        'span',
	                        null,
	                        text
	...
	function getSidebarMenus() {
	    var headMenu = (0, _HeaderMenuUtil.getCurrentHeaderMenuByUrl)();
	    if (!headMenu) {
	        return [];
	    }
	    var menusTree = (0, _common.convertToTree)(_menus2.default, headMenu);
	...
	exports.getCurrentSidebarMenu = getCurrentSidebarMenu;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _extractPath = __webpack_require__(170);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var UserAvatar = function (_React$Component) {
	    ...
	    _createClass(UserAvatar, [{
	        key: 'getCurrentLoginUserAvatar',
	        value: function getCurrentLoginUserAvatar() {
	            var user = this.props.user;
	            if (!user) {
	                return '';
	            }
	            var userName = user.name || user.loginname;
	            var avatar = user.avatar;
	            if (avatar) {
	                return _react2.default.createElement('img', { className: this.props.className, src: avatar, alt: '用户头像' });
	            }
	            var userNameFirstChar = userName[0];
	            ...
	            var backgroundColor = colors[userNameFirstChar.charCodeAt(0) % colors.length];
	            return _react2.default.createElement(
	                'span',
	                { className: this.props.className, style: { backgroundColor: backgroundColor } },
	                userName[0]
	            );
	        }
	    }, {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _historyLibActions = __webpack_require__(154);
	...
	var _TransitionUtils = __webpack_require__(263);

	var _isActive2 = __webpack_require__(267);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _applyMiddleware = __webpack_require__(272);
...
/***/ function(module, exports) {
	...
	exports.setHeaderCurrentMenu = setHeaderCurrentMenu;
	exports.setSidebarMenus = setSidebarMenus;
	exports.setSidebarMenuStatus = setSidebarMenuStatus;
	var TOGGLE_SIDEBAR = exports.TOGGLE_SIDEBAR = 'TOGGLE_SIDEBAR ';
	var SET_HEADER_CURRENT_MENU = exports.SET_HEADER_CURRENT_MENU = 'SET-HEADER-CURRENT-MENU ';
	var SET_SIDEBAR_MENUS = exports.SET_SIDEBAR_MENUS = 'SET_SIDEBAR_MENUS';
	var SET_SIDEBAR_MENU_STATUS = exports.SET_SIDEBAR_MENU_STATUS = 'SET_SIDEBAR_MENU_STATUS';
	...
	function setSidebarMenuStatus(status) {
	    return {
...
/***/ function(module, exports, __webpack_require__) {
	...
	function getFirstPath(node) {
	    ...
	    for (var i = 0; i < _menus2.default.length; i++) {
	        var menu = _menus2.default[i];
	...
	var headMenus = _menus2.default.filter(function (menu, index, arr) {
	    return !(0, _common.hasParent)(arr, menu);
	});
	headMenus.forEach(function (headMenu) {
	    headMenu.path = getFirstPath(headMenu) || '/';
	});

	exports.default = headMenus;
	module.exports = exports['default'];
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = _storage2.default.session.get('menus') || [];
	/*
	 export default [
	 {
	 key: 'system',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _runTransitionHook = __webpack_require__(160);

	var _runTransitionHook2 = _interopRequireDefault(_runTransitionHook);

	var _parsePath = __webpack_require__(150);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _PatternUtils = __webpack_require__(155);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var getPrototype = __webpack_require__(275),
	    isHostObject = __webpack_require__(276),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Index = function (_Component) {
	    ...
	    function Index() {
	        ...
	        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_Object$getPrototypeO = Object.getPrototypeOf(Index)).call.apply(_Object$getPrototypeO, [this].concat(args))), _this), _this.state = {}, _temp), _possibleConstructorReturn(_this, _ret);
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _AllRoutes = __webpack_require__(200);
	    ...
	    indexRoute: {
	        getComponent: function getComponent(location, cb) {
	            __webpack_require__.e/* nsure */(7, function (require) {
	                cb(null, __webpack_require__(203));
	            });
	        }
	    },
	    childRoutes: _AllRoutes2.default
	};
	_AllRoutes2.default.push({
	    path: '/system/settings',
	    getComponent: function getComponent(location, cb) {
	        __webpack_require__.e/* nsure */(9, function (require) {
	            cb(null, __webpack_require__(198));
	        });
	    }
	}, {
	    path: '*',
	    getComponent: function getComponent(location, cb) {
	        __webpack_require__.e/* nsure */(10, function (require) {
	            cb(null, __webpack_require__(202));
	        });
	    }
	});
	...
	browserHistory.listen(function () /* data */{
	    _pubsubmsg2.default.publish('current-header-menu');
	    _pubsubmsg2.default.publish('set-sidebar-menus');

	    var currentSidebarMenu = (0, _SidebarMenuUtil.getCurrentSidebarMenu)();
	    var selectedKeys = currentSidebarMenu ? currentSidebarMenu.key : '';
	    var openKeys = currentSidebarMenu ? currentSidebarMenu.parentKeys : [];
	    _pubsubmsg2.default.publish('current-sidebar-menu', {
	        selectedKeys: selectedKeys,
	        openKeys: openKeys
	    });
	    _pubsubmsg2.default.publish('set-header-breadcrumb');
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Sidebar = __webpack_require__(199);
	...
	var Container = function (_React$Component) {
	    ...
	    function Container() {
	        ...
	        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_Object$getPrototypeO = Object.getPrototypeOf(Container)).call.apply(_Object$getPrototypeO, [this].concat(args))), _this), _this.handleToggleSidebar = function () {
	            _this.props.dispatch((0, _actions.toggleSidebar)());
	        }, _this.handleToggleMenu = function (info) {
	            var selectedKeys = _this.props.sidebar.selectedKeys;
	            var data = {
	                selectedKeys: selectedKeys,
	                openKeys: info.openKeys
	            };
	            _this.props.dispatch((0, _actions.setSidebarMenuStatus)(data));
	    ...
	    _createClass(Container, [{
	        ...
	        value: function componentDidMount() {
	            ...
	            _pubsubmsg2.default.subscribeAcceptOldMsg('current-header-menu', function () {
	                dispatch((0, _actions.setHeaderCurrentMenu)());
	            });
	            _pubsubmsg2.default.subscribeAcceptOldMsg('set-sidebar-menus', function () {
	                dispatch((0, _actions.setSidebarMenus)());
	            });
	            _pubsubmsg2.default.subscribeAcceptOldMsg('current-sidebar-menu', function (data) {
	                dispatch((0, _actions.setSidebarMenuStatus)(data));
	            });
	        }
	    }, {
	        key: 'render',
	        value: function render() {
	            var centerLeft = this.props.sidebar.hidden ? 0 : this.props.style.centerLeft;
	            return _react2.default.createElement(
	                'div',
	                null,
	                _react2.default.createElement(_Header2.default, _extends({}, this.props, { onToggleSidebar: this.handleToggleSidebar })),
	                _react2.default.createElement(_Sidebar2.default, _extends({}, this.props, { onToggle: this.handleToggleMenu })),
	                _react2.default.createElement(
	                    'div',
	                    { className: 'admin-container', style: { left: centerLeft } },
	                    this.props.children
	                )
	            );
	        }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Header = function (_React$Component) {
	    ...
	    function Header() {
	        ...
	        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_Object$getPrototypeO = Object.getPrototypeOf(Header)).call.apply(_Object$getPrototypeO, [this].concat(args))), _this), _this.handleExit = function () {
	            _request2.default.post('/signout').end(function (err, res) {
	                if (err || !res.ok) {
	                    _antd.message.error(_tipMessage2.default.logoutError);
	                } else {
	    ...
	    _createClass(Header, [{
	        ...
	        value: function render() {
	            ...
	            var headerLogoWidth = _props$style.headerLogoWidth;
	            var headerLogo = _props$style.headerLogo;
	            var _props$headerNav = // TODO item.subMenus如果有子菜单，再处理
	            this.props.headerNav;
	            var current = _props$headerNav.current;
	            var headMenus = _props$headerNav.headMenus;


	            var headMenusJsx = [];
	            headMenus.forEach(function (item) {
	                if (item.key !== 'system') {
	                    // 系统的顶级菜单不在头部导航显示
	                    headMenusJsx.push(_react2.default.createElement(
	                        _antd.Menu.Item,
	                        { key: item.key },
	                        _react2.default.createElement(
	                            _reactRouter.Link,
	                            { to: item.path },
	                            _react2.default.createElement(_FAIcon2.default, { type: item.icon }),
	                            _react2.default.createElement(
	                                'span',
	                                null,
	                                item.text
	            ...
	            var currentLoginUser = (0, _common.getCurrentLoginUser)();
	            return _react2.default.createElement(
	                'header',
	                { className: 'admin-header' },
	                _react2.default.createElement(
	                    'div',
	                    { className: 'admin-logo', style: { width: headerLogoWidth } },
	                    _react2.default.createElement(
	                        _reactRouter.Link,
	                        { to: '/' },
	                        headerLogo
	                ...
	                _react2.default.createElement(
	                    'div',
	                    { className: 'admin-nav', style: { left: headerLogoWidth } },
	                    _react2.default.createElement(
	                        'a',
	                        { className: 'admin-sidebar-toggle', onClick: this.props.onToggleSidebar },
	                        _react2.default.createElement(_FAIcon2.default, { type: 'fa-bars' })
	                    ),
	                    _react2.default.createElement(
	                        _antd.Menu,
	                        {
	                    ...
	                    _react2.default.createElement(
	                        ...
	                        _react2.default.createElement(
	                            ...
	                            _react2.default.createElement(
	                                _reactRouter.Link,
	                                { to: '/system/profile/message' },
	                                _react2.default.createElement(_UserAvatar2.default, { className: 'admin-user-avatar', user: currentLoginUser }),
	                                _react2.default.createElement(
	                                    'span',
	                                    null,
	                        ...
	                        _react2.default.createElement(
	                            ...
	                            _react2.default.createElement(
	                                _antd.Popconfirm,
	                                { placement: 'bottomRight', title: '您确定要退出系统吗？', onConfirm: this.handleExit },
	                                _react2.default.createElement(
	                                    'a',
	                                    { href: '#' },
	                                    _react2.default.createElement(_FAIcon2.default, { type: 'fa-sign-out' }),
	                                    _react2.default.createElement(
	                                        'span',
	                                        null,
	                                        '退出系统'
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.getCurrentHeaderMenuByUrl = undefined;

	var _HeaderMenus = __webpack_require__(165);
	 ...
	 * @returns {*}
	 */
	var getCurrentHeaderMenuByUrl = exports.getCurrentHeaderMenuByUrl = function getCurrentHeaderMenuByUrl() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var maxWidth = 200;
	var minWidth = 60;
	var scrollBarWidth = (0, _common.getScrollBarWidth)();
	var isSidebarCollapsed = _Settings2.default.collapseSidebar();
	var collapsedStyle = { // 收起的
	...
	var defaultState = {
	    ...
	    headerNav: {
	        current: '1',
	        headMenus: _HeaderMenus2.default
	    },
	    sidebar: {
	        sidebarMenus: [],
	        hidden: false,
	...
	exports.default = (0, _redux.combineReducers)({
	    style: function style() {
	        var state = arguments.length <= 0 || arguments[0] === undefined ? defaultState.style : arguments[0];
	        var action = arguments[1];

	        switch (action.type) {
	            case _actions.TOGGLE_SIDEBAR:
	                // 展开收起左侧菜单栏
	                _Settings2.default.collapseSidebar(!state.isSidebarCollapsed);
	                return (0, _objectAssign2.default)({}, state, !state.isSidebarCollapsed ? collapsedStyle : expandedStyle);
	            default:
	                return state;
	        }
	    },
	    headerNav: function headerNav() {
	        var state = arguments.length <= 0 || arguments[0] === undefined ? defaultState.headerNav : arguments[0];
	        var action = arguments[1];

	        var pathNames = location.pathname.split('/');
	        var currentHeadMenuKey = pathNames && pathNames.length && pathNames[1];
	        switch (action.type) {
	            case _actions.SET_HEADER_CURRENT_MENU:
	                // 设置头部菜单选中状态
	                return (0, _objectAssign2.default)({}, state, {
	    ...
	    sidebar: function sidebar() {
	        var state = arguments.length <= 0 || arguments[0] === undefined ? defaultState.sidebar : arguments[0];
	        var action = arguments[1];

	        var sidebarMenus = (0, _SidebarMenuUtil.getSidebarMenus)();
	        switch (action.type) {
	            case _actions.SET_SIDEBAR_MENUS:
	                // 是否显示或者隐藏左侧菜单
	            ...
	            case _actions.SET_SIDEBAR_MENU_STATUS:
	                // 设置左侧菜单状态，展开状态以及选中状态
	                return (0, _objectAssign2.default)({}, state, {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Sidebar = function (_React$Component) {
	    ...
	    function Sidebar() {
	        ...
	        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_Object$getPrototypeO = Object.getPrototypeOf(Sidebar)).call.apply(_Object$getPrototypeO, [this].concat(args))), _this), _this.handleToggle = function (info) {
	            _this.props.onToggle(info);
	        }, _temp), _possibleConstructorReturn(_this, _ret);
	    }
	    ...
	    _createClass(Sidebar, [{
	        ...
	        value: function render() {
	            var _props$style = this.props.style;
	            var sidebarStyle = _props$style.sidebarStyle;
	            var sidebarInnerStyle = _props$style.sidebarInnerStyle;
	            var sidebarMode = _props$style.sidebarMode;
	            var _props$sidebar = this.props.sidebar;
	            var hidden = _props$sidebar.hidden;
	            var sidebarMenus = _props$sidebar.sidebarMenus;
	            var openKeys = _props$sidebar.openKeys;
	            var selectedKeys = _props$sidebar.selectedKeys;

	            var style = (0, _objectAssign2.default)({}, sidebarStyle, hidden ? { width: 0 } : {});
	            var innerStyle = (0, _objectAssign2.default)({}, sidebarInnerStyle, hidden ? { width: 0 } : {});

	            return _react2.default.createElement(
	                'div',
	                { className: 'admin-sidebar', style: style },
	                _react2.default.createElement(
	                    'div',
	                    { className: 'admin-sidebar-inner', style: innerStyle },
	                    _react2.default.createElement(
	                        _antd.Menu,
	                        {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Routes3 = __webpack_require__(204);

	var _Routes4 = _interopRequireDefault(_Routes3);

	var _Routes5 = __webpack_require__(206);

	var _Routes6 = _interopRequireDefault(_Routes5);

	var _Routes7 = __webpack_require__(214);

	var _Routes8 = _interopRequireDefault(_Routes7);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	exports.default = [].concat(_Routes2.default, _Routes4.default, _Routes6.default, _Routes8.default);
	module.exports = exports['default'];
	...
	exports.default = [{
	    ...
	    getComponent: function getComponent(location, cb) {
	        __webpack_require__.e/* nsure */(0, function (require) {
	            cb(null, __webpack_require__(184));
	        });
	    }
	}];
	module.exports = exports['default'];
	...
	exports.default = [{
	    ...
	    getComponent: function getComponent(location, cb) {
	        __webpack_require__.e/* nsure */(5, function (require) {
	            cb(null, __webpack_require__(205));
	        });
	    }
	}];
	module.exports = exports['default'];
	...
	exports.default = [{
	    ...
	    getComponent: function getComponent(location, cb) {
	        __webpack_require__.e/* nsure */(4, function (require) {
	            cb(null, __webpack_require__(207));
	        });
	    }
	}, {
	    ...
	    getComponent: function getComponent(location, cb) {
	        __webpack_require__.e/* nsure */(2, function (require) {
	            cb(null, __webpack_require__(209));
	        });
	    }
	}];
	module.exports = exports['default'];
	...
	exports.default = [{
	    ...
	    getComponent: function getComponent(location, cb) {
	        __webpack_require__.e/* nsure */(3, function (require) {
	            cb(null, __webpack_require__(212));
	        });
	    }
	}, {
	    ...
	    getComponent: function getComponent(location, cb) {
	        __webpack_require__.e/* nsure */(8, function (require) {
	            cb(null, __webpack_require__(213));
	        });
	    }
	}];
	module.exports = exports['default'];
...
/***/ function(module, exports, __webpack_require__) {
	...
	'use strict';
	var strictUriEncode = __webpack_require__(278);
	var objectAssign = __webpack_require__(246);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _historyLibCreateHashHistory = __webpack_require__(232);
	...
	var _useRoutes = __webpack_require__(162);
