...
var config = {
    ...
    name: 'Organizational Structure', // 应用程序名称
    description: '企业组织架构demo项目', // 社区的描述
    ...
    site_logo: 'favicon.png', // default is `name`
    site_icon: 'favicon.png', // 默认没有 favicon, 这里填写网址
    // 右上角的导航区
    site_navs: [
    ...
    oneapm_key: 'UwpSBVACBQJe2c4cFFxHVVhJCBa664BeDxhTBgcCSd822QgHHwsFSVRU94efA1UZUQIbBlM=',
