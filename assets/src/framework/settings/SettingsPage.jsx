...
import {SketchPicker/* , ChromePicker, CompactPicker, MaterialPicker, PhotoshopPicker,  SliderPicker, SwatchesPicker */} from 'react-color';
...
class SettingsPage extends React.Component {
    ...
    handleChange = (color) => {
        ...
        let themeColor = Settings.themeColors();
            ...
            <Page header={pageHeader}>
                <Form horizontal>
                    ...
                    <FormItem wrapperCol={{span: 6, offset: 1}}>
                        <label className="ant-checkbox-vertical" style={{cursor: 'pointer'}}>
                            <Checkbox
                                checked={this.state.sidebarMenuAlwaysOpen}
