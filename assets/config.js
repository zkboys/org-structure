module.exports = {
    dev: {
        ...
        library: [
            ...
            {from: 'node_modules/react-redux/dist/react-redux.js', to: 'react-redux.min.js'},
            {from: 'node_modules/react-router/umd/ReactRouter.js', to: 'react-router.min.js'},
    ...
    pro: {
        ...
        library: [
            ...
            {from: 'node_modules/react-router/umd/ReactRouter.min.js', to: 'react-router.min.js'},
            {from: 'node_modules/moment/min/moment-with-locales.min.js', to: 'moment.min.js'},
            {from: 'node_modules/superagent/superagent.js', to: 'superagent.min.js'},
            // 登录页面相关
            {from: 'src/page/sign-in/background.jpg'},
